...
struct t_local_unknown_c0_WMOBJ *D_00E39A00;
//00E39A04
struct VECTOR D_00E39A08;
struct t_local_unknown_c0_WMOBJ D_00E39A18;
struct t_local_unknown_c0_WMOBJ *D_00E39AD8;
struct t_wm_local_8_ttt *D_00E39ADC;
struct t_local_unknown_c0_WMOBJ D_00E39AE0;
int D_00E39BA0[2];
int D_00E39BA8[2];
int D_00E39BB0;
short D_00E39BB4;
...
int D_00E39BC0;
//00E39BC4
struct t_local_unknown_c0_WMOBJ D_00E39BC8[0x10];
struct t_wm_b8 *D_00E3A7C8;
struct t_local_unknown_c0_WMOBJ *D_00E3A7CC_OBJLIST;
struct t_local_unknown_c0_WMOBJ *D_00E3A7D0_PLAYEROBJ;
struct t_local_unknown_c0_WMOBJ *D_00E3A7D4;
...
short D_00E3A85C;
////////////////////////////////////////
void C_00761134(struct t_local_unknown_c0_WMOBJ *);
...
void C_00760FB0(struct t_wm_local_8_rrr *bp08) {
	...
	D_00E39A00 =
	D_00E39AD8 =
	D_00E3A7D0_PLAYEROBJ = 0;
	C_00761134(&D_00E39A18);
	C_00761134(&D_00E39AE0);
	D_00E39AE0.f_50_model = 9;
	D_00E39A18.pNext = 0;
	D_00E39AE0.pNext = 0;
	C_00762F75(0, 0, 0);
	D_00E3A7D8 = bp08;
...
struct t_local_unknown_c0_WMOBJ *C_007610B3() {
	struct t_local_unknown_c0_WMOBJ *local_1;
...
//clean struct?
void C_00761134(struct t_local_unknown_c0_WMOBJ *bp08) {
	struct {
		unsigned *local_2;
		unsigned *local_1;
	}lolo;
...
int C_00761176() {
	...
	for(local_1 = D_00E39A00; local_1 && local_1->f_50_model < 0x20; local_1 = local_1->pNext);

	return local_1 != 0;
}

void C_007611FF(struct t_local_unknown_c0_WMOBJ *);

void C_007611AE() {
	struct t_local_unknown_c0_WMOBJ *local_1;

	if(D_00E3A7D0_PLAYEROBJ && D_00E39AD8 && D_00E39AD8->f_08 == 0) {
		local_1 = D_00E3A7D0_PLAYEROBJ;
		C_007611FF(local_1);
		D_00E39AD8->f_08 = local_1;
		D_00E3A7D0_PLAYEROBJ = D_00E39AD8;
	}
}

void C_007611FF(struct t_local_unknown_c0_WMOBJ *bp08) {
	struct {
		struct t_wm_b8 *local_3;
		struct t_local_unknown_c0_WMOBJ *local_2;
		struct t_local_unknown_c0_WMOBJ *local_1;
	}lolo;

	if(bp08 == D_00E39AD8)
		D_00E39AD8 = 0;
	if(bp08 == D_00E3A7D0_PLAYEROBJ)
		D_00E3A7D0_PLAYEROBJ = 0;
	...
	lolo.local_3 = C_00768A37(bp08->f_50_model);
...
void C_00761407(struct t_local_unknown_c0_WMOBJ *);

void C_00761313() {
	struct t_local_unknown_c0_WMOBJ *local_1;

	if(D_00E3A7D0_PLAYEROBJ && D_00E3A7D0_PLAYEROBJ->f_08) {
		local_1 = D_00E3A7D0_PLAYEROBJ->f_08;
		C_00761407(local_1);
		local_1->f_04 = D_00E3A7D0_PLAYEROBJ;
		local_1->f_0c_POSITION = D_00E3A7D0_PLAYEROBJ->f_0c_POSITION;
		local_1->f_1c = D_00E3A7D0_PLAYEROBJ->f_1c;
		local_1->f_40 = D_00E3A7D0_PLAYEROBJ->f_40;
		local_1->f_4c = D_00E3A7D0_PLAYEROBJ->f_4c;
		local_1->f_3c = D_00E3A7D0_PLAYEROBJ->f_3c;
		local_1->f_3e = D_00E3A7D0_PLAYEROBJ->f_3e;
		local_1->f_51 |= 2;
		D_00E3A7D0_PLAYEROBJ->f_08 = 0;
		D_00E3A7D0_PLAYEROBJ = local_1;
	}
}

void C_00761407(struct t_local_unknown_c0_WMOBJ *bp08) {
...
void C_0076142D() {
	...
	if(D_00E39AD8 && D_00E39AD8->f_08) {
		...
		local_1->f_0c_POSITION = D_00E39AD8->f_0c_POSITION;
...
void C_0076156B(struct t_local_unknown_c0_WMOBJ *);

void C_0076154F() {
	if(D_00E3A7D0_PLAYEROBJ)
		C_0076156B(D_00E3A7D0_PLAYEROBJ);
}

void C_0076156B(struct t_local_unknown_c0_WMOBJ *bp08) {
	C_007611FF(bp08);
	bp08->pNext = D_00E3A7D4;
	D_00E3A7D4 = bp08;
	D_00E3A7C8 = C_00768A37(bp08->f_50_model);
	if(D_00E3A7C8)
		D_00E3A7C8->f_24 = 0;
}
...
void C_007615D6() {
	if(D_00E3A7D0_PLAYEROBJ && D_00E3A7D0_PLAYEROBJ->f_08) {
		C_0076156B(D_00E3A7D0_PLAYEROBJ->f_08);
		D_00E3A7D0_PLAYEROBJ->f_08 = 0;
	}
}
...
void C_00761644(short bp08, short bp0c) {
	struct {
		struct t_wm_local_08_MESHHEADER *local_2;
		struct t_local_unknown_c0_WMOBJ *local_1;
	}lolo;

	for(lolo.local_1 = D_00E39A00; lolo.local_1; lolo.local_1 = lolo.local_1->pNext) {
		for(lolo.local_2 = &(lolo.local_1->f_60[0]); lolo.local_2 < &(lolo.local_1->f_60[6]); lolo.local_2 ++) {
			if(lolo.local_2->f_04_numTriangles == bp08 && lolo.local_2->f_06_numVertices == bp0c)
				lolo.local_2->f_00_triPtr = 0;
		}//end for
	}//end for
}
...
void C_007616B3() {
	if(D_00E3A7D0_PLAYEROBJ)
		D_00E39AD8 = D_00E3A7D0_PLAYEROBJ;
}
...
struct t_wm_local_08_MESHHEADER *C_007616E3() {
	return D_00E3A7D0_PLAYEROBJ?D_00E3A7D0_PLAYEROBJ->f_60:0;
}

int C_0076170B() {
	return D_00E39AD8?D_00E39AD8->f_50_model:0;
}

//current transportation mode
int C_00761735_PLAYER_CURRENT_MODEL() {
	return D_00E3A7D0_PLAYEROBJ?D_00E3A7D0_PLAYEROBJ->f_50_model:0;
}

struct t_local_unknown_c0_WMOBJ *C_0076175F() {
	return D_00E39AD8;
}

int C_00761769_PLAYERMODEL_MASK(int bp08) {
	return (D_00E3A7D0_PLAYEROBJ && D_00E3A7D0_PLAYEROBJ->f_50_model < 0x20)?((bp08 & (1 << D_00E3A7D0_PLAYEROBJ->f_50_model)) != 0):0;
}

int __007617B7(int bp08) {
	return (D_00E39AD8 && D_00E39AD8->f_50_model < 0x20)?((bp08 & (1 << D_00E39AD8->f_50_model)) != 0):0;
}
...
int C_00761844() {
	// 4 is chocobo, 
	return D_00E3A7D0_PLAYEROBJ?
		(D_00E3A7D0_PLAYEROBJ->f_50_model != 4 && D_00E3A7D0_PLAYEROBJ->f_50_model != 0x13 && D_00E3A7D0_PLAYEROBJ->f_50_model != 0x29 && D_00E3A7D0_PLAYEROBJ->f_50_model != 0x2a)?0:1
		:0
	;
}
...
int C_007618B7() {
	return D_00E39AD8?
		(D_00E39AD8->f_50_model != 4 && D_00E39AD8->f_50_model != 0x13 && D_00E39AD8->f_50_model != 0x29 && D_00E39AD8->f_50_model != 0x2a)?0:1
		:0
	;
}
...
void C_0076616A(struct t_local_unknown_c0_WMOBJ *);//load object coordinates?

void C_0076197B(int bp08) {
	short bp_08[4];

	if(D_00E39AD8) {
		D_00E39AD8->f_50_model = bp08;
		switch(bp08) {
			case 3:
				if(C_00768C59() == 0)
...
void __00761B4E(short bp08) {
	if(D_00E3A7D0_PLAYEROBJ) {
		D_00E3A7D0_PLAYEROBJ->f_40 = bp08;
		D_00E3A7D0_PLAYEROBJ->f_4c = bp08;
		D_00E3A7D0_PLAYEROBJ->f_3e = 0;
	}
}
...
void C_00761C07(struct t_local_unknown_c0_WMOBJ *, short);

void C_00761BEE(short bp08) {
	C_00761C07(D_00E39AD8, bp08);
}

void C_00761C07(struct t_local_unknown_c0_WMOBJ *bp08, short bp0c) {
	struct {
...
void __00761DDC(short bp08) {
	C_00761C07(D_00E3A7D0_PLAYEROBJ, bp08);
}
...
short C_00761EEC() {
	return D_00E3A7D0_PLAYEROBJ?D_00E3A7D0_PLAYEROBJ->f_3c + D_00E3A7D0_PLAYEROBJ->f_3e:0;
}

void C_00761F22(int bp08) {
	if(D_00E39AD8)
		D_00E39AD8->f_0c_POSITION.f_04_Y += bp08;
}
...
int C_00761F77() {
	return D_00E3A7D0_PLAYEROBJ?(D_00E3A7D0_PLAYEROBJ->f_51 & 1) != 0:0;
}

void C_00761FAA(int bp08) {
	if(D_00E3A7D0_PLAYEROBJ) {
		if(bp08)
			D_00E3A7D0_PLAYEROBJ->f_51 |= 0x80;
		else
			D_00E3A7D0_PLAYEROBJ->f_51 &= ~0x80;
	}
}
...
int C_00761FE8() {
	return 	D_00E3A7D0_PLAYEROBJ?(D_00E3A7D0_PLAYEROBJ->f_51 & 0x80) != 0:0;
}


int C_0076201E() {
	return D_00E3A7D0_PLAYEROBJ?D_00E3A7D0_PLAYEROBJ->f_42:0;
}

int C_00762047(int bp08) {
	struct t_local_unknown_c0_WMOBJ *local_1;

	for(local_1 = D_00E39A00; local_1 && local_1->f_50_model != bp08; local_1 = local_1->pNext);
	if(local_1)
		D_00E39AD8 = local_1;
...
void __0076208E() {
	if(D_00E3A7D0_PLAYEROBJ && D_00E3A7D0_PLAYEROBJ->f_04)
		D_00E39AD8 = D_00E3A7D0_PLAYEROBJ->f_04;
}

int C_007620B6() {
	return (D_00E3A7D0_PLAYEROBJ && D_00E39AD8 && D_00E3A7D0_PLAYEROBJ != D_00E39AD8 && (D_00E39AD8->f_51 & 0x10) == 0);
}

void C_00762102(int bp08) {
	if(D_00E3A7D0_PLAYEROBJ)
		D_00E3A7D0_PLAYEROBJ->f_50_model = bp08;
}

void C_0076211B(int bp08) {
	if(D_00E3A7D0_PLAYEROBJ)
		D_00E3A7D0_PLAYEROBJ->f_4a = bp08;
}

int C_00762136_PLAYER_GROUND_TYPE() {
	return D_00E3A7D0_PLAYEROBJ?D_00E3A7D0_PLAYEROBJ->f_4a & 0x1f:0;
}

int C_00762162() {
	return D_00E3A7D0_PLAYEROBJ?(D_00E3A7D0_PLAYEROBJ->f_4a >> 9) & 0x1f:0;
}

int C_00762191_ON_CHOCO_TRACKS() {
	return D_00E3A7D0_PLAYEROBJ?(D_00E3A7D0_PLAYEROBJ->f_4a >> 0xf) & 1:0;
}

int C_007621C0() {
	return D_00E3A7D0_PLAYEROBJ?(D_00E3A7D0_PLAYEROBJ->f_4a >> 5) & 7:0;
}

void C_00762207(struct t_local_unknown_c0_WMOBJ *, struct VECTOR *);
...
void C_00762207(struct t_local_unknown_c0_WMOBJ *bp08, struct VECTOR *bp0c) {
	if(bp0c && bp08) {
		C_00750202(bp0c);
		if(bp08->f_51 & 0x80) {
			bp08->f_0c_POSITION.f_00_X = bp0c->f_00_X;
			bp08->f_0c_POSITION.f_08_Z = bp0c->f_08_Z;
		} else {
			bp08->f_0c_POSITION = *bp0c;
			bp08->f_0c_POSITION.f_04_Y += C_007622E5(bp08->f_4a, bp08->f_50_model);
		}
		bp08->f_42 = bp0c->f_04_Y;
		if(bp08->f_0c_POSITION.f_00_X != bp08->f_1c.f_00_X || bp08->f_0c_POSITION.f_08_Z != bp08->f_1c.f_08_Z)
			bp08->f_51 |= 1;
		else
			bp08->f_51 &= ~1;
	}
	...
	switch(bp0c) {
		...
		case 0x13:
			if((bp08 >= 3 && bp08 <= 6) || bp08 == 0x1a) {//else 007623F7
				if(D_00E3A7D0_PLAYEROBJ->f_51 & 1) {//else 0076239D
					if(D_00E39BB0 < 0)
...
void C_00762465(struct VECTOR *bp08) {
	C_00762207(D_00E3A7D0_PLAYEROBJ, bp08);
}

void C_0076247D(struct VECTOR *bp08) {
	C_00762207(D_00E3A7D0_PLAYEROBJ, bp08);
	if(D_00E3A7D0_PLAYEROBJ)
		D_00E3A7D0_PLAYEROBJ->f_1c = D_00E3A7D0_PLAYEROBJ->f_0c_POSITION;
}

void C_007624C5(struct VECTOR *bp08) {
	int local_1;

	local_1 = C_00762136_PLAYER_GROUND_TYPE();
	C_00762207(D_00E3A7D0_PLAYEROBJ, bp08);
	if(local_1 == 1 || local_1 == 0x19)
		D_00E3A854 = 0x1e;
	else if(local_1 == 2 || local_1 == 0xc)
		D_00E3A854 = 0;
	if((D_00E3A7D0_PLAYEROBJ->f_51 & 0x80) == 0 && D_00E3A854) {//else 007626EA
		D_00E3A854 -= (D_00E3A7D0_PLAYEROBJ->f_51 & 1) != 0;
		if(D_00E3A850) {//else 00762680
			if(D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y > D_00E3A7D0_PLAYEROBJ->f_1c.f_04_Y ^ D_00E3A850 > 0) {
				D_00E3A850 = 0;
				D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y = D_00E3A7D0_PLAYEROBJ->f_1c.f_04_Y;
				//goto 0076267E
			} else if(D_00E3A7D0_PLAYEROBJ->f_51 & 1) {//else 0076266C
				if(D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y > D_00E3A7D0_PLAYEROBJ->f_1c.f_04_Y) {//else 00762622
					if(D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y - D_00E3A7D0_PLAYEROBJ->f_1c.f_04_Y > D_00E3A850) {//else 00762616
						D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y = D_00E3A7D0_PLAYEROBJ->f_1c.f_04_Y + D_00E3A850;
						D_00E3A850 <<= 1;
					} else {
						D_00E3A850 = 0;
					}
					...
					if(D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y - D_00E3A7D0_PLAYEROBJ->f_1c.f_04_Y < D_00E3A850) {//else 00762660
						D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y = D_00E3A7D0_PLAYEROBJ->f_1c.f_04_Y + D_00E3A850;
						D_00E3A850 <<= 1;
					} else {
						D_00E3A850 = 0;
			...
			if(D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y - D_00E3A7D0_PLAYEROBJ->f_1c.f_04_Y < -0x32) {//else 007626B5
				D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y = D_00E3A7D0_PLAYEROBJ->f_1c.f_04_Y;
				D_00E3A850 = -1;
				//goto 007626E8
			} else if(D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y - D_00E3A7D0_PLAYEROBJ->f_1c.f_04_Y > 0x32) {//else 007626E8
				D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y = D_00E3A7D0_PLAYEROBJ->f_1c.f_04_Y;
				D_00E3A850 = 1;
			}
		}
...
void C_00762702(int bp08) {
	if(D_00E3A7D0_PLAYEROBJ)
		D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y = bp08;
}

void C_0076271B(int bp08) {
	if(D_00E3A7D0_PLAYEROBJ) {
		D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y = bp08;
		D_00E3A7D0_PLAYEROBJ->f_51 |= 4;
	}
}

void __00762748(int bp08) {
	if(D_00E3A7D0_PLAYEROBJ)
		D_00E3A7D0_PLAYEROBJ->f_4e = bp08;
}

void C_00762763(struct VECTOR *bp08) {
	if(bp08 && D_00E39AD8)
		*bp08 = D_00E39AD8->f_0c_POSITION;
}

void C_00762798_SET_VECTOR_TO_PLAYER_POS(struct VECTOR *bp08) {
	if(bp08 && D_00E3A7D0_PLAYEROBJ) {
		*bp08 = D_00E3A7D0_PLAYEROBJ->f_0c_POSITION;
	}
}
...
void C_00762802(struct VECTOR *bp08) {
	if(bp08 && D_00E3A7D0_PLAYEROBJ)
		*bp08 = D_00E3A7D0_PLAYEROBJ->f_1c;
}

void C_00762837() {
	if(D_00E39AD8) {
		if(D_00E39AD8->f_51 & 4) {
			D_00E39AD8->f_0c_POSITION.f_00_X = D_00E39AD8->f_1c.f_00_X;
			D_00E39AD8->f_0c_POSITION.f_08_Z = D_00E39AD8->f_1c.f_08_Z;
		} else {
			D_00E39AD8->f_0c_POSITION = D_00E39AD8->f_1c;
		}
		D_00E39AD8->f_51 &= ~1;
	}
}
...
void C_007628B5() {
	if(D_00E3A7D0_PLAYEROBJ) {
		if(D_00E3A7D0_PLAYEROBJ->f_51 & 4) {
			D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_00_X = D_00E3A7D0_PLAYEROBJ->f_1c.f_00_X;
			D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_08_Z = D_00E3A7D0_PLAYEROBJ->f_1c.f_08_Z;
		} else {
			D_00E3A7D0_PLAYEROBJ->f_0c_POSITION = D_00E3A7D0_PLAYEROBJ->f_1c;
		}
		D_00E3A7D0_PLAYEROBJ->f_51 &= ~1;
	}
}

void C_00762933() {
	if(D_00E3A7D0_PLAYEROBJ)
		D_00E3A7D0_PLAYEROBJ->f_51 &= ~2;
}
...
struct t_local_unknown_c0_WMOBJ *C_00762993(void);

struct t_local_unknown_c0_WMOBJ *C_0076296E() {
	struct t_local_unknown_c0_WMOBJ *local_1 = 0;
	local_1 = C_00762993();
	if(local_1)
		C_00762837();
...
int C_00762A21(struct t_local_unknown_c0_WMOBJ *, struct t_local_unknown_c0_WMOBJ *);

struct t_local_unknown_c0_WMOBJ *C_00762993() {
	int local_2 = 0;
	struct t_local_unknown_c0_WMOBJ *local_1 = 0;
	if(D_00E39AD8) {//else 00762A10
		if(D_00E39AD8->f_50_model != 0xd || C_0074D330()) {//else 00762A10
...
int C_00762A21(struct t_local_unknown_c0_WMOBJ *bp08, struct t_local_unknown_c0_WMOBJ *bp0c) {
	struct {//x2c
		int local_4;
		int local_3;
		int local_2;
	...
	if(
		...
		bp08->f_50_model < 0x1a && bp0c->f_50_model < 0x1a &&
		bp0c->f_50_model != 0x15 && bp0c->f_50_model != 0x16 && bp0c->f_50_model != 0x17
	) {
		lolo.local_3 = bp0c->f_0c_POSITION.f_00_X - bp08->f_0c_POSITION.f_00_X;
		if(lolo.local_3 > 0x24000)
			lolo.local_3 -= 0x48000;
		else if(lolo.local_3 < -0x24000)
			lolo.local_3 += 0x48000;
		lolo.local_4 = bp0c->f_0c_POSITION.f_08_Z - bp08->f_0c_POSITION.f_08_Z;
		...
		if(/*lolo.local_5*/inline_abs(lolo.local_3) < 0x400 && /*lolo.local_6*/inline_abs(lolo.local_4) < 0x400) {
			...
			if(lolo.local_3 >= 0 && lolo.local_3 < 8 && lolo.local_4 >= 0 && lolo.local_4 < 8) {
				lolo.local_1 = /*lolo.local_9*/((D_0096DDB0[bp08->f_50_model][lolo.local_4] >> lolo.local_3) & 1) == 0 && ((D_0096DDB0[bp0c->f_50_model][7 - lolo.local_4] >> (7 - lolo.local_3)) & 1) == 0?0:1;
				if(lolo.local_1) {
					lolo.local_3 = bp0c->f_0c_POSITION.f_00_X - bp08->f_1c.f_00_X;
					if(lolo.local_3 > 0x24000)
						lolo.local_3 -= 0x48000;
					else if(lolo.local_3 < -0x24000)
						lolo.local_3 += 0x48000;
					lolo.local_4 = bp0c->f_0c_POSITION.f_08_Z - bp08->f_1c.f_08_Z;
					if(lolo.local_4 > 0x1c000)
						lolo.local_4 -= 0x38000;
					else if(lolo.local_4 < -0x1c000)
						lolo.local_4 += 0x38000;
...
struct t_local_unknown_c0_WMOBJ *__00762D2A() {
...
void C_00762D74(struct t_wm_local_18 *bp08) {
	struct {
		...
		t_local_unknown_c0_WMOBJ *local_5;
		short local_4; char _ocal_4[2];
		struct SVECTOR local_3;
		t_local_unknown_c0_WMOBJ *local_1;
	}lolo;

	for(lolo.local_5 = 0, lolo.local_1 = D_00E39A00; lolo.local_1; lolo.local_5 = lolo.local_1, lolo.local_1 = lolo.local_1->pNext) {
		if(lolo.local_1 != D_00E3A7D0_PLAYEROBJ) {//else 00762E65
			C_00750134(&(lolo.local_1->f_0c_POSITION), &lolo.local_3, &lolo.local_4, &lolo.local_6);
			if(lolo.local_4 == bp08->f_10 && lolo.local_6 == bp08->f_12) {//else 00762E65
				C_0074CC07_updateObjMeshMaybe(bp08, &lolo.local_3, lolo.local_1->f_60, &(lolo.local_1->f_42), 0, &(lolo.local_1->f_4a), lolo.local_1->f_50_model);
				if((lolo.local_1->f_51 & 0x80) == 0)
					lolo.local_1->f_0c_POSITION.f_04_Y = lolo.local_1->f_42 + C_007622E5(lolo.local_1->f_4a, lolo.local_1->f_50_model);
				lolo.local_1->f_51 |= 2;
			}
		}
	}//end for
...
void C_00762E87(int bp08, int bp0c) {
	if(D_00E39AD8) {
		if(bp08 || bp0c) {
			D_00E39AD8->f_0c_POSITION.f_00_X += bp08;
			D_00E39AD8->f_0c_POSITION.f_08_Z += bp0c;
			if(D_00E39AD8->f_0c_POSITION.f_00_X < 0)
				D_00E39AD8->f_0c_POSITION.f_00_X += 0x48000;
			if(D_00E39AD8->f_0c_POSITION.f_00_X >= 0x48000)
				D_00E39AD8->f_0c_POSITION.f_00_X -= 0x48000;
			if(D_00E39AD8->f_0c_POSITION.f_08_Z < 0)
				D_00E39AD8->f_0c_POSITION.f_08_Z += 0x38000;
			if(D_00E39AD8->f_0c_POSITION.f_08_Z >= 0x38000)
				D_00E39AD8->f_0c_POSITION.f_08_Z -= 0x38000;
			D_00E39AD8->f_51 |= 1;
		}
	}
...
int C_00762F9A(int bp08, int bp0c) {
	...
	lolo.local_36.f_00_X = 0;
	lolo.local_36.f_02_Y = 0;
	lolo.local_36.f_04_Z = 0;
...
void C_0076312D(struct SVECTOR *bp08) {
	if(bp08) {
		bp08->f_00_X = D_00E3A848;
		bp08->f_02_Y = 0;
		bp08->f_04_Z = D_00E3A84C;
	}
}

void C_007631DF(struct t_local_unknown_c0_WMOBJ *);
...
void C_0076315C() {
	...
	for(local_1 = D_00E39A00; local_1; local_1 = local_1->pNext) {
		local_1->f_51 &= ~7;
		D_00E3A7C8 = C_00768A37(local_1->f_50_model);
		if(D_00E3A7C8)
			D_00E3A7C8->f_24 = 0;
	}//end for
}

void C_007631DF(struct t_local_unknown_c0_WMOBJ *bp08) {
	if(bp08->f_04) {
		if((bp08->f_51 & 1) || (bp08->f_04->f_51 & 1))
			bp08->f_04 = 0;
	}
	bp08->f_1c = bp08->f_0c_POSITION;
}

void C_0076328F(struct t_local_unknown_c0_WMOBJ *);
void C_00763B74(struct t_local_unknown_c0_WMOBJ *);
...
void C_0076328F(struct t_local_unknown_c0_WMOBJ *bp08) {
	struct {//x74
		int local_20[4];
		int local_16;
	...
	if(bp08->f_51 & 8)
		bp08->f_51 &= ~2;
	if(bp08 && D_00E3A7D0_PLAYEROBJ && (bp08->f_51 & 2)) {//else 00763AA9
		lolo.local_9 = C_00768A37(bp08->f_50_model);
		if(lolo.local_9 == 0) {
			bp08->f_51 &= ~2;
			//goto 00763AA9
		} else {
			lolo.local_15 = 0;
			if(bp08->f_08 && (lolo.local_15 = C_00768A37(bp08->f_08->f_50_model)) == 0) {
				bp08->f_08->f_51 &= ~2;
				//goto 00763AA9
			} else {
				lolo.local_12 = 0;
				if(bp08->f_5d) {//else 0076338E
					...
					lolo.local_6 = /*lolo.local_22*/inline_abs(bp08->f_0c_POSITION.f_00_X - bp08->f_1c.f_00_X);
					if(lolo.local_6 >= 0x24000)
						lolo.local_6 = 0x48000 - lolo.local_6;
					lolo.local_10 = /*lolo.local_23*/inline_abs(bp08->f_0c_POSITION.f_08_Z - bp08->f_1c.f_08_Z);
					...
					if(bp08->f_50_model == 6) {//else 00763495
						bp08->f_58 = (bp08 == D_00E3A7D0_PLAYEROBJ) << 5;
						lolo.local_5 = /*lolo.local_24*/lolo.local_12?C_00763AAE(&(bp08->f_53)):0;
					} else if(C_00761805(0x2000, bp08->f_50_model)) {
...
//007634BF
				...
				lolo.local_8.f_00_X =
				lolo.local_8.f_02_Y =
				lolo.local_8.f_04_Z = 0;
				if((bp08->f_51 & 0x80) && bp08 == D_00E3A7D0_PLAYEROBJ) {
					...
					lolo.local_9->f_44.sPos.f_04 = (float)(bp08->f_0c_POSITION.f_04_Y - D_00DE6A04);
					lolo.local_9->f_44.sPos.f_08 = 0;
					lolo.local_8.f_02_Y = D_00E39BB8 + bp08->f_3c + bp08->f_3e;
					lolo.local_8.f_04_Z = D_00E39BBC;
					//goto 00763710
				} else {
					C_0075042B(&lolo.local_4);

					lolo.local_6 = bp08->f_0c_POSITION.f_00_X - lolo.local_4.f_00_X;
					if(lolo.local_6 < -0x24000)
					...
					lolo.local_13 = bp08->f_0c_POSITION.f_08_Z - lolo.local_4.f_08_Z;
					...
					lolo.local_10 = bp08->f_0c_POSITION.f_04_Y - D_00DE6A04 + bp08->f_44;
				...
				if(bp08->f_50_model == 6) {//else 0076382E
					lolo.local_16 = bp08->f_53;
					if(D_00E3A7D0_PLAYEROBJ->f_50_model == 6 && (D_00E3A7D0_PLAYEROBJ->f_51 & 1)) {//else 007637F9
					...
					lolo.local_8.f_00_X = D_00E3A848;
					lolo.local_8.f_04_Z = D_00E3A84C;
				...
				if(lolo.local_15) {//else 007638B7
					if(bp08->f_50_model == 3) {//else 0076388E
						if(bp08->f_08)
				...
				if(bp08->f_50_model == 3) {//else 007639D0
					if(bp08->f_51 & 0x80)
						bp08->f_58 = 0x20;
					else if(bp08->f_58)
						bp08->f_58 ++;
				...
				lolo.local_8.f_00_X =
				lolo.local_8.f_04_Z = 0;
				if(bp08->f_50_model == 3) {
					lolo.local_8.f_00_X = -0xa;
					lolo.local_8.f_04_Z = 0x50;
				} else if(bp08->f_50_model == 0xb){
					lolo.local_8.f_04_Z = -0x168;
				}
				C_00753D00(&lolo.local_8, bp08->f_3c + bp08->f_3e + C_0074D319() * 4);
				lolo.local_14->f_00.pad1 = lolo.local_6 + lolo.local_8.f_00_X;
				bp08->f_48 = bp08->f_42 - lolo.local_11;
				lolo.local_14->f_00.pad2 = lolo.local_13 + lolo.local_8.f_04_Z;
			}
		}
	}
}
...
int C_00763AAE(unsigned char *bp08) {
	...
	int bp_08 = C_00762136_PLAYER_GROUND_TYPE();
	switch(D_00E3A858) {
		case 1:
			if(bp_08 == 0xb)
				D_00E3A858 = 2;
...
void C_00763B74(struct t_local_unknown_c0_WMOBJ *bp08) {
	if(bp08 && D_00E3A7D0_PLAYEROBJ && (bp08->f_51 & 2)) {
		if(
			(
				((C_00761805(7, bp08->f_50_model) && !(bp08->f_5d >= 2 && bp08->f_5d <= 5)) || C_0076192A(bp08->f_50_model)) &&
				(bp08 != D_00E3A7D0_PLAYEROBJ || D_00E3A850 == 0) &&
...
void C_00763C35(void *bp08) {
	...
	for(i = 0; i < 0x40; i ++)
		D_00E399C0[i] = 0;
	for(i = 0; i < 3; i ++) {
		D_00E3A818[i].f_08_Z = 0;
		D_00E3A818[i].f_04_Y = 0;
		D_00E3A818[i].f_00_X = 0;
	}
	D_00E39BA8[0] =
	D_00E39BA8[1] = 0;
	D_00E39BA0[0] =
...
void C_00763D6C(int bp08) {
	if(D_00E3A7D0_PLAYEROBJ) {
		if(bp08)
			D_00E3A7D0_PLAYEROBJ->f_51 |= 0x10;
		else
			D_00E3A7D0_PLAYEROBJ->f_51 &= ~0x10;
	}
}
...
void C_00764142(short bp08, short bp0c) {
	...
	D_00E39AD8 = &D_00E39A18;
	C_00750134(&(D_00E3A7D0_PLAYEROBJ->f_0c_POSITION), 0, &lolo.local_1, &lolo.local_2);
	C_00763E31(0x8000 | (((lolo.local_2 * 0x24 + lolo.local_1) << 4) & 0x3ff0) | ((bp08 + bp0c * 5) & 0xf), 3);
}

void C_0076420A(struct t_local_unknown_c0_WMOBJ *);

void C_007641A7_ScriptLoop() {
	struct t_local_unknown_c0_WMOBJ *local_1;

	D_00E3A7CC_OBJLIST = &D_00E39A18;
	D_00E39AD8 = &D_00E39A18;
...
void C_0076420A(struct t_local_unknown_c0_WMOBJ *bp08) {
	struct {
	...
	D_00E39BC0 = 0;
	if(D_00E3A7CC_OBJLIST->f_46) {//else 007642E1
		lolo.local_1 = 0;
		while(lolo.local_1 == 0) {
			lolo.local_2 = D_00E3A810[D_00E3A7CC_OBJLIST->f_46];
			D_00E3A7CC_OBJLIST->f_46 ++;
	...
	if(bp08->f_04 && D_00E3A7DC == 0 && C_0074D4B6()) {
		C_00764014(bp08->f_04->f_50_model, ((C_007186B9() & 0x20) == 0?0:1) + 3);
	}
}
...
void C_00764336(unsigned short bp08) {
	struct {
		struct VECTOR bp_1c;
		struct t_local_unknown_c0_WMOBJ *bp_0c;
		int bp_08;
		int bp_04;
	}lolo;
	...
	switch(bp08) {
		...
		case 0x19:
			...
			if(C_00762047(C_0076488C()))
				D_00E39ADC->f_00 = C_00753C23(&(D_00E39AD8->f_0c_POSITION), &(lolo.bp_0c->f_0c_POSITION)) >> 4;
			D_00E39AD8 = lolo.bp_0c;
		break;
		case 0x1a:
			lolo.bp_04 = C_0076488C();
			lolo.bp_1c = D_00E39AD8->f_0c_POSITION;
			lolo.bp_1c.f_04_Y = 0;
...
int C_0076488C() {
	...
	if((D_00E39ADC->f_04 & 3) < 3) {//else 007649C4
		...
		switch(D_00E39ADC->f_00) {
			case 0: lolo.bp_08 = D_00E39AD8->f_0c_POSITION.f_00_X >> 0xd; break;
			case 1: lolo.bp_08 = D_00E39AD8->f_0c_POSITION.f_08_Z >> 0xd; break;
			case 2: lolo.bp_08 = D_00E39AD8->f_0c_POSITION.f_00_X & 0x1fff; break;
			case 3: lolo.bp_08 = D_00E39AD8->f_0c_POSITION.f_08_Z & 0x1fff; break;
			...
			case 8: lolo.bp_08 = C_00761735_PLAYER_CURRENT_MODEL(); break;//current transportation mode?
			case 0xf: lolo.bp_08 = D_00E39AD8->f_50_model; break;
			...
			case 0x10: lolo.bp_08 = C_00753BE8_RAND(); break;//wm:random?
...
void C_00764CCB(unsigned short bp08) {
	...
	if(D_00E39ADC == 0 || D_00E3A7CC_OBJLIST == 0)
		C_0074C9A0(0x3d);//<empty>:some error management?
	D_00E39ADC->f_04 = bp08;
	D_00E39ADC->f_00 = D_00E3A810[D_00E3A7CC_OBJLIST->f_46];
	D_00E3A7CC_OBJLIST->f_46 ++;
	D_00E39ADC ++;
}
...
int C_00764D59(unsigned short bp08) {
	...
	switch(bp08) {
		case 0x200:
			bp08 = D_00E3A810[D_00E3A7CC_OBJLIST->f_46 ++];
			D_00E3A7CC_OBJLIST->f_46 = bp08;
		break;
		case 0x201:
			bp08 = D_00E3A810[D_00E3A7CC_OBJLIST->f_46 ++];
			if(C_0076488C() == 0)
		...
		break;
		case 0x203:
			if(D_00E3A7CC_OBJLIST->f_54 > 0) {
				D_00E3A7CC_OBJLIST->f_54 --;
				lolo.local_3 = &(D_00E3A7CC_OBJLIST->f_2c[D_00E3A7CC_OBJLIST->f_54]);
				D_00E3A7CC_OBJLIST->f_46 = lolo.local_3->f_00;
				D_00E3A7CC_OBJLIST->f_56 = lolo.local_3->f_02;
				D_00E3A7CC_OBJLIST->f_57 = lolo.local_3->f_03;
			} else {
				D_00E3A7CC_OBJLIST->f_46 = 0;
				D_00E3A7CC_OBJLIST->f_57 = 0;
				if(D_00E3A7DC) {//else 00764EE9
					if(D_00E3A7CC_OBJLIST == &D_00E39A18) {//else 00764EE7
						for(lolo.local_1 = D_00E39A00; lolo.local_1; lolo.local_1 = lolo.local_1->pNext) {
							C_00764014(lolo.local_1->f_50_model, 1);
						}
					}
				} else {
					if(D_00E3A7CC_OBJLIST == &D_00E39A18) {
						C_007640BC(2);
					} else {
						C_00764014(D_00E3A7CC_OBJLIST->f_50_model, 2);
					}
				}
				lolo.local_2 = 1;
			}
		break;
		default:
			D_00E3A7CC_OBJLIST->f_52 = C_0076488C();
			if(D_00E3A7CC_OBJLIST->f_52 < 0x40) {
				C_00764014(D_00E3A7CC_OBJLIST->f_52, bp08 - 0x204);
			} else {
				D_00E3A7CC_OBJLIST->f_52 = D_00E39AD8->f_50_model;
...
int C_00764F9C(unsigned short bp08) {
	struct {
		...
		int bp_1c;
		int bp_18;
		struct t_local_unknown_c0_WMOBJ *bp_14;
		int bp_10;
		int bp_0c;
		short bp_08[4];
	}lolo;
	...
	switch(bp08) {
		...
		break;
		case 0x343:
			C_007664C2(D_00E39AD8->f_50_model);
		...
		case 0x302:
			C_007616CB();
			C_0074D4C0(D_00E3A7D0_PLAYEROBJ->f_40);
		break;
		case 0x330:
			C_00762047(C_0076488C());
		break;
		case 0x346:
			D_00E39AD8->f_50_model = C_0076488C();
		break;
		case 0x307:
		...
		case 0x304:
			...
			if(D_00E39AD8 == D_00E3A7D0_PLAYEROBJ)
		...
		case 0x333:
			...
			if(D_00E39AD8 && C_00762047(C_0076488C()))
				lolo.bp_14->f_40 = C_00753F2E(&(lolo.bp_14->f_0c_POSITION), &(D_00E39AD8->f_0c_POSITION)) + lolo.bp_0c;
			D_00E39AD8 = lolo.bp_14;
		break;
		case 0x344:
			lolo.bp_0c = C_0076488C();
			if(lolo.bp_0c >= 0 && lolo.bp_0c < 3) {
				D_00E3A818[lolo.bp_0c] = D_00E39AD8->f_0c_POSITION;
				D_00E3A818[lolo.bp_0c].f_04_Y = 0;
			}
		break;
		case 0x345:
			lolo.bp_0c = C_0076488C();
			if(lolo.bp_0c >= 0 && lolo.bp_0c < 3) {
				D_00E39AD8->f_4c =
				D_00E39AD8->f_40 = C_00753F2E(&(D_00E39AD8->f_0c_POSITION), &(D_00E3A818[lolo.bp_0c]));
			}
		break;
		case 0x308:
			lolo.bp_10 = C_0076488C();
			lolo.bp_0c = C_0076488C();
			D_00E39AD8->f_0c_POSITION.f_00_X &= 0x1fff;
			D_00E39AD8->f_0c_POSITION.f_00_X |= lolo.bp_0c << 0xd;
			D_00E39AD8->f_0c_POSITION.f_08_Z &= 0x1fff;
			D_00E39AD8->f_0c_POSITION.f_08_Z |= lolo.bp_10 << 0xd;
			if(D_00E39AD8->f_0c_POSITION.f_00_X != D_00E39AD8->f_1c.f_00_X || D_00E39AD8->f_0c_POSITION.f_08_Z != D_00E39AD8->f_1c.f_08_Z)
				D_00E39AD8->f_51 |= 1;
		break;
		case 0x309:
			lolo.bp_10 = C_0076488C();
			lolo.bp_0c = C_0076488C();
			D_00E39AD8->f_0c_POSITION.f_00_X &= ~0x1fff;
			D_00E39AD8->f_0c_POSITION.f_00_X |= lolo.bp_0c & 0x1fff;
			D_00E39AD8->f_0c_POSITION.f_08_Z &= ~0x1fff;
			D_00E39AD8->f_0c_POSITION.f_08_Z |= lolo.bp_10 & 0x1fff;
			if(D_00E39AD8->f_0c_POSITION.f_00_X != D_00E39AD8->f_1c.f_00_X || D_00E39AD8->f_0c_POSITION.f_08_Z != D_00E39AD8->f_1c.f_08_Z)
				D_00E39AD8->f_51 |= 1;
		break;
		case 0x347:
			...
			if(lolo.bp_14 && C_00762047(C_0076488C())) {
				lolo.bp_14->f_0c_POSITION = D_00E39AD8->f_0c_POSITION;
		...
		break;
		case 0x34f:
			D_00E39AD8->f_0c_POSITION.f_04_Y = C_0076488C();
			D_00E39AD8->f_51 |= 0x80;
		break;
		case 0x30d:
			C_00762837();
		...
		break;
		case 0x305:
			D_00E3A7CC_OBJLIST->f_56 = C_0076488C();
		break;
		case 0x331:
		...
		case 0x34d:
			...
			lolo.bp_0c = C_0076488C();
			if(D_00E39AD8)
				C_0075BFE5(lolo.bp_0c, D_00E39AD8->f_50_model, lolo.bp_10, lolo.bp_18);
		break;
		case 0x34e:
		...
		case 0x334:
			if(D_00E3A7DC == 0) {
				lolo.bp_14 = D_00E39AD8;
				C_00762047(D_00E3A7CC_OBJLIST->f_52);
		...
		case 0x341:
			if(D_00E3A7DC == 0) {
				...
				D_00E3A7CC_OBJLIST->f_46 -= lolo.bp_0c;
		...
		case 0x306:
			...
			D_00E3A7CC_OBJLIST->f_56 --;
			if(D_00E3A7CC_OBJLIST->f_56)
				D_00E3A7CC_OBJLIST->f_46 --;
			else
				D_00E39BC0 = 1;
			lolo.bp_24.f_00_X =
			lolo.bp_24.f_02_Y = 0;
			lolo.bp_24.f_04_Z = D_00E39AD8->f_55 << (((D_00E39AD8->f_51 & 0x40)?1:0) << 2);
			C_00753D00(&lolo.bp_24, D_00E39AD8->f_4c);
			C_00762E87(lolo.bp_24.f_00_X, lolo.bp_24.f_04_Z);
			D_00E39AD8->f_44 -= D_00E39AD8->f_5c;
			D_00E39AD8->f_0c_POSITION.f_04_Y += D_00E39AD8->f_5f;

			return D_00E3A7CC_OBJLIST->f_56 > 0;
	}//end switch
...
void C_00765F61() {
	...
	if(D_00E3A7DC == 0 && (D_00E3A7D0_PLAYEROBJ->f_51 & 8) == 0) {//else 0076603B
		if(C_00761769_PLAYERMODEL_MASK(0x2000))
			local_2 = (D_00E3A7D0_PLAYEROBJ->f_0c_POSITION.f_04_Y - D_00E3A7D0_PLAYEROBJ->f_42) < 0x1f4;
		else
			local_2 = (D_00E3A7D0_PLAYEROBJ->f_51 & 0x80)?0:1;
		if(local_2) {//else 0076603B
			...
			if(local_1 >= 3) {//else 00766032
				...
				if(local_1 == 7 && C_00761769_PLAYERMODEL_MASK(0x2000) == 0)
					C_007628B5();
			} else {
				D_00E3A85C = 0;
			}
...
void C_007660DB(struct t_local_unknown_c0_WMOBJ *);//save object coordinates?
...
void C_007660DB(struct t_local_unknown_c0_WMOBJ *bp08) {
	struct t_wm_local_8_rrr *local_1;

	if(D_0096DE80[bp08->f_50_model] < 6) {
		local_1 = &(D_00E3A7D8[D_0096DE80[bp08->f_50_model]]);
		local_1->f_00 = (bp08->f_1c.f_00_X & 0x0007ffff) | ((bp08->f_50_model << 0x13) & 0x00f80000) | ((bp08->f_40 << 0x14) & 0xff000000);
		local_1->f_04 = (bp08->f_1c.f_08_Z & 0x0003ffff) | ((bp08->f_1c.f_04_Y << 0x12) & 0xfffc0000);
	}
}

//load object coordinates?
void C_0076616A(struct t_local_unknown_c0_WMOBJ *bp08) {
	struct t_wm_local_8_rrr *local_1;

	for(local_1 = &(D_00E3A7D8[0]); local_1 < &(D_00E3A7D8[6]) && ((local_1->f_00 >> 0x13) & 0x1f) != bp08->f_50_model; local_1 ++);
	if(local_1 < &(D_00E3A7D8[6]) && bp08) {
		bp08->f_0c_POSITION.f_00_X =
		bp08->f_1c.f_00_X = local_1->f_00 & 0x7ffff;
		bp08->f_0c_POSITION.f_04_Y =
		bp08->f_1c.f_04_Y = local_1->f_04 >> 0x12;
		bp08->f_0c_POSITION.f_08_Z =
		bp08->f_1c.f_08_Z = local_1->f_04 & 0x3ffff;
		bp08->f_4c =
		bp08->f_3c =
