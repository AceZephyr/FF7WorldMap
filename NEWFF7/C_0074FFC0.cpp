...
int D_00E04600;
int D_00E04604;
struct t_wm_local_0c_TRIANGLE *D_00E04608;
...
void C_00750134(struct VECTOR *bp08, struct SVECTOR *bp0c, short *bp10, short *bp14) {
	...
	if(bp0c) {
		bp0c->f_00_X = bp08->f_00_X & 0x1fff;
		bp0c->f_02_Y = 0;
		bp0c->f_04_Z = bp08->f_08_Z & 0x1fff;
	}
}

void C_00750202(struct VECTOR *bp08) {
	if(bp08) {//else 0075027A
		if(bp08->f_00_X >= 0x48000)
			bp08->f_00_X -= 0x48000;
		else if(bp08->f_00_X < 0)
			bp08->f_00_X += 0x48000;
		if(bp08->f_08_Z >= 0x38000)
			bp08->f_08_Z -= 0x38000;
		else if(bp08->f_08_Z < 0)
			bp08->f_08_Z += 0x38000;
	}
}
...
void C_0075027C(struct VECTOR *bp08, int bp0c) {
	...
	if(C_0074D30F() != 2) {//else 00750427
		...
		if(D_00E28CC8) {//else 00750403
			if(bp08->f_00_X - D_00E04918.f_00_X > 0x24000)
				D_00E04918.f_00_X += 0x48000;
			else if(bp08->f_00_X - D_00E04918.f_00_X < -0x24000)
				D_00E04918.f_00_X -= 0x48000;
			if(bp08->f_08_Z - D_00E04918.f_08_Z > 0x1c000)
				D_00E04918.f_08_Z += 0x38000;
			else if(bp08->f_08_Z - D_00E04918.f_08_Z < -0x1c000)
				D_00E04918.f_08_Z -= 0x38000;
			D_00E04918.f_00_X = (D_00E04918.f_00_X * 3 + bp08->f_00_X) >> 2;
			D_00E04918.f_08_Z = (D_00E04918.f_08_Z * 3 + bp08->f_08_Z) >> 2;
			C_00750202(&D_00E04918);
			if(bp08->f_00_X - D_00E04918.f_00_X > 0) local_1 = bp08->f_00_X - D_00E04918.f_00_X; else local_1 = -(bp08->f_00_X - D_00E04918.f_00_X);
			if(bp08->f_08_Z - D_00E04918.f_08_Z > 0) local_2 = bp08->f_08_Z - D_00E04918.f_08_Z; else local_2 = -(bp08->f_08_Z - D_00E04918.f_08_Z);
...
void C_0075079D(short bp08, int bp0c) {
	...
	C_007616B3();
	C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_8);
	C_00762802(&lolo.local_4);
	if(D_00E28CBC) {//else 00750922
		lolo.local_18.f_00_X =
		lolo.local_18.f_02_Y = 0;
		lolo.local_18.f_04_Z = -0x2000;//0xe000
		C_00753D00(&lolo.local_18, -bp08);
		lolo.local_16.f_00_X = lolo.local_8.f_00_X + lolo.local_18.f_00_X;
		lolo.local_16.f_04_Y = lolo.local_8.f_04_Y;
		lolo.local_16.f_08_Z = lolo.local_8.f_08_Z + lolo.local_18.f_04_Z;
		if(lolo.local_16.f_00_X < 0)
			lolo.local_16.f_00_X += 0x48000;
		else if(lolo.local_16.f_00_X >= 0x48000)
			lolo.local_16.f_00_X -= 0x48000;
		if(lolo.local_16.f_08_Z < 0)
			lolo.local_16.f_08_Z += 0x38000;
		else if(lolo.local_16.f_08_Z >= 0x38000)
			lolo.local_16.f_08_Z -= 0x38000;
	...
	C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_12);
	D_00E37D28 = 0x157C;
...
void C_007509B2(struct VECTOR *bp08) {
	...
	lolo.bp_14 = (bp08->f_00_X - 0x4000) / 0x8000;
	lolo.bp_28 = (bp08->f_08_Z - 0x4000) / 0x8000;
	lolo.bp_1c =  (bp08->f_00_X + 0x4000) / 0x8000;
	lolo.bp_2c =  (bp08->f_08_Z + 0x4000) / 0x8000;
	lolo.bp_0c = 0;
...
void C_0075155A(struct t_wm_local_18 *bp08, struct t_wm_local_08_ter *bp0c) {
	...
	bp08->f_04 = (struct t_wm_local_0c_TRIANGLE *)&(lolo.local_3[2]);
...
void C_00751AC4(struct VECTOR *bp08, short bp0c, int bp10[][5]) {
	...
	lolo.bp_74[0] = (bp08->f_00_X & 0x1fff) - 0x1000;
	lolo.bp_74[1] = 0;
	lolo.bp_74[2] = (bp08->f_08_Z & 0x1fff) - 0x1000;
	lolo.bp_5c.f_04_Y = 0;
	for(lolo.bp_64 = -2; lolo.bp_64 <= 2; lolo.bp_64 ++) {
		for(lolo.bp_60 = -2; lolo.bp_60 <= 2; lolo.bp_60 ++) {
			if(inline_abs(lolo.bp_60) <= 1 && inline_abs(lolo.bp_64) <= 1) {//else 00751CAF
				...
				lolo.bp_5c.f_00_X = (lolo.bp_60 << 0xd) - lolo.bp_74[0];
				lolo.bp_5c.f_08_Z = (lolo.bp_64 << 0xd) - lolo.bp_74[2];
				psx_OuterProduct12(&lolo.bp_10, &lolo.bp_5c, &lolo.bp_ac);
				psx_OuterProduct12(&lolo.bp_30, &lolo.bp_5c, &lolo.bp_20);
				bp10[lolo.bp_64 + 2][lolo.bp_60 + 2] = /*lolo.bp_b8*/(lolo.bp_ac.f_04_Y < 0 && lolo.bp_20.f_04_Y > 0);
			}
		}
	}
}
...
struct t_wm_30_temp {
	...
	struct t_wm_local_0c_TRIANGLE *f_1c;
	short f_20;
	short f_22;
	short f_24;
	short f_26;
...
void C_00751EFC(struct VECTOR *bp08, struct VECTOR *bp0c, struct VECTOR *bp10, short bp14) {
	...
	if(lolo.bp_50 > lolo.bp_14)
		lolo.bp_0c.f_00_X += 0x2000;
	else if(lolo.bp_50 < lolo.bp_14)
		lolo.bp_0c.f_00_X -= 0x2000;
	if(lolo.bp_104 > lolo.bp_10)
		lolo.bp_0c.f_04_Z += 0x2000;
	else if(lolo.bp_104 < lolo.bp_10)
		lolo.bp_0c.f_04_Z -= 0x2000;
	if(C_0074D4DC())
		sprintf(D_00E28C48, "PS%d%d%d%d.rsd  POS: %d %d", lolo.bp_14 / 10, lolo.bp_14 % 10, lolo.bp_10 / 10, lolo.bp_10 % 10, bp0c->f_00_X & 0x1fff, bp0c->f_08_Z & 0x1fff);
	lolo.local_9.f_02_Y = 0;
	psx_SetTransMatrix(&lolo.bp_12c);
	lolo.local_16 = C_00761735_PLAYER_CURRENT_MODEL() == 5?0x15e:0xc8;
	...
	for(lolo.bp_ec = &(lolo.bp_102c[0][0]); lolo.bp_ec < &(lolo.bp_102c[0][8]); lolo.bp_ec ++) {
		...
		lolo.local_9.f_02_Y += lolo.local_66;
	}
	lolo.local_9.f_02_Y = 0;
	...
	while(lolo.bp_f4 < lolo.bp_10c) {
		...
		lolo.bp_48.f_00_X = (lolo.bp_f0 << 0xd) - lolo.bp_0c.f_00_X;
		lolo.bp_48.f_02_Y = -lolo.bp_0c.f_02_Y;
		lolo.bp_48.f_04_Z = (lolo.bp_f8 << 0xd) - lolo.bp_0c.f_04_Z;
	...
	if(lolo.bp_ec < &(lolo.bp_102c[D_00E28CB8][8])) {//else 00752898
		...
		D_00E28C30.f_04_Y = lolo.bp_ec->f_00[0].f_28;
...
struct t_wm_30_temp *C_00752D02(struct t_wm_local_18 *bp08, struct t_wm_f0_temp *bp0c, short bp10, short bp14) {
	struct {
		...
		int local_9;
		struct t_wm_local_08_MESHHEADER *local_8;
		int local_7;
			...
			for(lolo.local_2 = &(bp0c[lolo.local_1].f_00[0]); lolo.local_2 < &(bp0c[lolo.local_1].f_00[5]); lolo.local_2 ++) {
				if(lolo.local_2->f_24 == 1) {//else 00752E61
					if(lolo.local_2->f_20 == bp10 && lolo.local_2->f_22 == bp14) {//else 00752E55
						...
						lolo.local_2->f_28 = lolo.local_6.f_04_Y;
						if(C_0074CC07_updateObjMeshMaybe(bp08, &(lolo.local_2->f_10), lolo.local_8, &(lolo.local_2->f_28), &(lolo.local_2->f_1c), &(lolo.local_2->f_2a), lolo.local_9) && inline_abs(lolo.local_2->f_28 - lolo.local_6.f_04_Y) < 0xc8)
							lolo.local_2->f_24 = 2;
						else
							lolo.local_2->f_24 = 3;
			...
			for(lolo.local_2 = &(bp0c[lolo.local_1].f_00[0]); lolo.local_2 < &(bp0c[lolo.local_1].f_00[5]); lolo.local_2 ++) {
				if(lolo.local_2->f_24 == 1) {
					if(lolo.local_2->f_20 == bp10 && lolo.local_2->f_22 == bp14) {//else 00752FE5
						lolo.local_2->f_18 = bp08;
						lolo.local_2->f_28 = lolo.local_6.f_04_Y;
						if(C_0074CC07_updateObjMeshMaybe(bp08, &(lolo.local_2->f_10), lolo.local_8, &(lolo.local_2->f_28), &(lolo.local_2->f_1c), &(lolo.local_2->f_2a), lolo.local_9))
							lolo.local_2->f_24 = 2;
						else
							lolo.local_2->f_24 = 3;
					} else if(lolo.local_10 == 0) {
...
void C_007530B3(struct t_wm_f0_temp *bp08, struct SVECTOR *bp0c, struct SVECTOR *bp10, int bp14) {
	...
	lolo.local_1->f_28 = 0;
	lolo.local_1->f_1c = 0;
	lolo.local_1->f_26 = bp10->f_02_Y;

	lolo.local_1 ++;

	lolo.local_1->f_00 = lolo.local_6;
	lolo.local_1->f_00.f_00_X -= bp14;
	C_00750134(&(lolo.local_1->f_00), &(lolo.local_1->f_10), &(lolo.local_1->f_20), &(lolo.local_1->f_22));
	lolo.local_1->f_24 = 1;
	lolo.local_1->f_28 = 0;
	lolo.local_1->f_1c = 0;
...
void C_007533AF() {
	...
	lolo.bp_14 = (lolo.local_4.f_00_X - 0x4000) >> 0xf;
	lolo.bp_1c = (lolo.local_4.f_08_Z - 0x4000) >> 0xf;
...
void C_007537AE(int *bp08) {
	...
	lolo.local_2 = &(D_00E28CD0->f_0c[D_00E04608->f_00_vert0idx]);
	lolo.local_3 = &(D_00E28CD0->f_0c[D_00E04608->f_01_vert1idx]);
	lolo.local_1 = &(D_00E28CD0->f_0c[D_00E04608->f_02_vert2idx]);
	bp08[0] = lolo.local_2->f_00_X + lolo.local_3->f_00_X + lolo.local_1->f_00_X;
	bp08[1] = lolo.local_2->f_02_Y + lolo.local_3->f_02_Y + lolo.local_1->f_02_Y;
	bp08[2] = lolo.local_2->f_04_Z + lolo.local_3->f_04_Z + lolo.local_1->f_04_Z;
}
