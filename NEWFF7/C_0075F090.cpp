...
struct t_wm_local_0c_TRIANGLE *D_00E36110;
int *D_00E36114;
...
struct t_wm_local_0c_TRIANGLE *D_00E38330;
//////////////////////////////////////////////////
...
void C_0075F0AD(struct SVECTOR *bp08, int bp0c) {
	...
	lolo.local_4 = 0;
	do {
		D_00E38338[lolo.local_4].f_00 = (float)bp08->f_00_X;
		D_00E38338[lolo.local_4].f_04 = (float)bp08->f_02_Y;
		D_00E38338[lolo.local_4].f_08 = (float)bp08->f_04_Z;
...
void C_0075F68C(struct t_wm_local_0c_TRIANGLE *bp08, struct t_wm_local_0c_TRIANGLE *bp0c, struct SVECTOR *bp10, struct POLY_GT3 *bp14) {
	struct {
		...
		int bp_0c;
		int bp_08;
		struct t_wm_local_0c_TRIANGLE *bp_04;
	}lolo;
	...
	lolo.bp_04 = bp08;
	do {
		lolo.bp_70 = D_00E397B8[lolo.bp_04->f_00_vert0idx] | D_00E397B8[lolo.bp_04->f_01_vert1idx] | D_00E397B8[lolo.bp_04->f_02_vert2idx];
		if(!(lolo.bp_70 & 0xff) | !(lolo.bp_70 & 0xff00))
			goto C_00760803;//through 00760858
		//-- --
		lolo.bp_8c = D_00E38938[lolo.bp_04->f_00_vert0idx].f_08 - D_00E38938[lolo.bp_04->f_01_vert1idx].f_08;
		lolo.bp_28 = D_00E38938[lolo.bp_04->f_02_vert2idx].f_08;
		lolo.bp_2c = C_00760CC4(&(D_00E38938[lolo.bp_04->f_00_vert0idx]), &(D_00E38938[lolo.bp_04->f_01_vert1idx]), &(D_00E38938[lolo.bp_04->f_02_vert2idx]));
		if(D_00E36110 == 0)
...
C_0075F866:
		//-- --
		lolo.bp_98 = D_00E38938[lolo.bp_04->f_00_vert0idx].f_08 - D_00E38938[lolo.bp_04->f_02_vert2idx].f_08;
		lolo.bp_50 = &(bp10[lolo.bp_04->f_00_vert0idx]);
		if(C_0075F090(lolo.bp_2c) < 0)
			goto C_00760803;//0076084C
		lolo.bp_6c = &(bp10[lolo.bp_04->f_01_vert1idx]);
		if(C_0075F090(lolo.bp_8c) < 0)
			goto C_0075F91F;//00760847
		lolo.bp_88 = &(bp10[lolo.bp_04->f_02_vert2idx]);
		if(C_0075F090(lolo.bp_98) < 0)
			goto C_0075F987;//00760842
		lolo.bp_28 = D_00E38938[lolo.bp_04->f_00_vert0idx].f_08;
		goto C_0075F987;//0076083D
C_0075F91F:
		lolo.bp_d4 = D_00E38938[lolo.bp_04->f_01_vert1idx].f_08 - D_00E38938[lolo.bp_04->f_02_vert2idx].f_08;
		lolo.bp_88 = &(bp10[lolo.bp_04->f_02_vert2idx]);
		if(C_0075F090(lolo.bp_d4) < 0)
			goto C_0075F987;//00760838
		lolo.bp_28 = D_00E38938[lolo.bp_04->f_01_vert1idx].f_08;
C_0075F987:
		lolo.bp_10 = C_0075F090(lolo.bp_28) - D_00E37D28;
		if(lolo.bp_10 > 0)
			goto C_0075FD4D;//00760833
		lolo.bp_94 = /*lolo.bp_108*/D_00E38938[lolo.bp_04->f_00_vert0idx].f_00 < lolo.bp_54;
		lolo.bp_d0 = /*lolo.bp_10c*/lolo.bp_54 < D_00E38938[lolo.bp_04->f_00_vert0idx].f_00;

		lolo.bp_68 = /*lolo.bp_110*/D_00E38938[lolo.bp_04->f_01_vert1idx].f_00 < lolo.bp_54;
		lolo.bp_e0 = /*lolo.bp_114*/lolo.bp_54 < D_00E38938[lolo.bp_04->f_01_vert1idx].f_00;
		lolo.bp_94 |= lolo.bp_68;
		lolo.bp_d0 |= lolo.bp_e0;

		lolo.bp_68 = /*lolo.bp_118*/D_00E38938[lolo.bp_04->f_02_vert2idx].f_00 < lolo.bp_54;
		lolo.bp_e0 = /*lolo.bp_11c*/lolo.bp_54 < D_00E38938[lolo.bp_04->f_02_vert2idx].f_00;
		lolo.bp_94 |= lolo.bp_68;
		lolo.bp_d0 |= lolo.bp_e0;
		...
		lolo.bp_94 = /*lolo.bp_120*/D_00E38938[lolo.bp_04->f_00_vert0idx].f_04 < lolo.bp_54;
		lolo.bp_d0 = /*lolo.bp_124*/lolo.bp_54 < D_00E38938[lolo.bp_04->f_00_vert0idx].f_04;

		lolo.bp_68 = /*lolo.bp_128*/D_00E38938[lolo.bp_04->f_01_vert1idx].f_04 < lolo.bp_54;
		lolo.bp_e0 = /*lolo.bp_12c*/lolo.bp_54 < D_00E38938[lolo.bp_04->f_01_vert1idx].f_04;
		lolo.bp_94 |= lolo.bp_68;
		lolo.bp_d0 |= lolo.bp_e0;

		lolo.bp_68 = /*lolo.bp_130*/D_00E38938[lolo.bp_04->f_02_vert2idx].f_04 < lolo.bp_54;
		lolo.bp_e0 = /*lolo.bp_134*/lolo.bp_54 < D_00E38938[lolo.bp_04->f_02_vert2idx].f_04;
		lolo.bp_94 |= lolo.bp_68;
		lolo.bp_d0 |= lolo.bp_e0;
		...
		D_00E37520 = 1;
C_0075FD4D:
		if(C_0075F090(D_00E38F38[lolo.bp_04->f_00_vert0idx][3]) > 0 && C_0075F090(D_00E38F38[lolo.bp_04->f_01_vert1idx][3]) > 0 && C_0075F090(D_00E38F38[lolo.bp_04->f_02_vert2idx][3]) > 0) {//else 007607FA
			lolo.bp_4c = 0;
			if(D_00E37524 == 0)
				goto C_00760243;//00760824
			C_00760D1B(&(D_00E38938[lolo.bp_04->f_00_vert0idx].f_08), &(D_00E38938[lolo.bp_04->f_01_vert1idx].f_08), &(D_00E38938[lolo.bp_04->f_02_vert2idx].f_08), &lolo.bp_48, &lolo.bp_44, &lolo.bp_dc);
...
//0075FF0E
			...
			lolo.bp_c8[lolo.bp_dc].a = 255.0f;
C_00760243:
			lolo.bp_14 = (int *)&(lolo.bp_04->f_08_u2);
			...
			if(C_0074C969()) {//get "isRendering"?//else 007607FA
				...
				if(C_0066E272(1, D_00E2BBD8[lolo.bp_84])) {//else 007607FA
					lolo.u_0 = (float)/*lolo.bp_138*/(lolo.bp_04->f_04_u0 - D_00E2D168[lolo.bp_84].f_00) * D_00E2BBD8[lolo.bp_84]->f_24;
					lolo.v_0 = (float)/*lolo.bp_13c*/(lolo.bp_04->f_05_v0 - D_00E2D168[lolo.bp_84].f_02) * D_00E2BBD8[lolo.bp_84]->f_28;
					lolo.u_1 = (float)/*lolo.bp_140*/(lolo.bp_04->f_06_u1 - D_00E2D168[lolo.bp_84].f_00) * D_00E2BBD8[lolo.bp_84]->f_24;
					lolo.v_1 = (float)/*lolo.bp_144*/(lolo.bp_04->f_07_v1 - D_00E2D168[lolo.bp_84].f_02) * D_00E2BBD8[lolo.bp_84]->f_28;
					lolo.u_2 = (float)/*lolo.bp_148*/(lolo.bp_04->f_08_u2 - D_00E2D168[lolo.bp_84].f_00) * D_00E2BBD8[lolo.bp_84]->f_24;
					lolo.v_2 = (float)/*lolo.bp_14c*/(lolo.bp_04->f_09_v2 - D_00E2D168[lolo.bp_84].f_02) * D_00E2BBD8[lolo.bp_84]->f_28;

					lolo.bp_40.f_00 = (float)/*lolo.bp_150*/lolo.bp_50->f_00_X * (1.0f/4096.0f);
					lolo.bp_40.f_04 = (float)/*lolo.bp_154*/lolo.bp_50->f_02_Y * (1.0f/4096.0f);
					lolo.bp_40.f_08 = (float)/*lolo.bp_158*/lolo.bp_50->f_04_Z * (1.0f/4096.0f);

					lolo.bp_60.f_00 = (float)/*lolo.bp_15c*/lolo.bp_6c->f_00_X * (1.0f/4096.0f);
					lolo.bp_60.f_04 = (float)/*lolo.bp_160*/lolo.bp_6c->f_02_Y * (1.0f/4096.0f);
					lolo.bp_60.f_08 = (float)/*lolo.bp_164*/lolo.bp_6c->f_04_Z * (1.0f/4096.0f);

					lolo.bp_7c.f_00 = (float)/*lolo.bp_168*/lolo.bp_88->f_00_X * (1.0f/4096.0f);
					lolo.bp_7c.f_04 = (float)/*lolo.bp_16c*/lolo.bp_88->f_02_Y * (1.0f/4096.0f);
					lolo.bp_7c.f_08 = (float)/*lolo.bp_170*/lolo.bp_88->f_04_Z * (1.0f/4096.0f);
					...
					lolo.bp_e8 = 1.0f / D_00E38F38[lolo.bp_04->f_00_vert0idx][3];
					MK_VERTEX_0(&(D_00E2BBD8[lolo.bp_84]->f_70.asVertex[0]), lolo.bp_ec, D_00E38F38[lolo.bp_04->f_00_vert0idx][0] * lolo.bp_e8, D_00E38F38[lolo.bp_04->f_00_vert0idx][1] * lolo.bp_e8, D_00E38F38[lolo.bp_04->f_00_vert0idx][2] * lolo.bp_e8, lolo.bp_e8, lolo.vcolor_0.rgba, lolo.u_0, lolo.v_0);
					lolo.bp_f0 = 1.0f / D_00E38F38[lolo.bp_04->f_01_vert1idx][3];
					MK_VERTEX_0(&(D_00E2BBD8[lolo.bp_84]->f_70.asVertex[1]), lolo.bp_f4, D_00E38F38[lolo.bp_04->f_01_vert1idx][0] * lolo.bp_f0, D_00E38F38[lolo.bp_04->f_01_vert1idx][1] * lolo.bp_f0, D_00E38F38[lolo.bp_04->f_01_vert1idx][2] * lolo.bp_f0, lolo.bp_f0, lolo.vcolor_1.rgba, lolo.u_1, lolo.v_1);
					lolo.bp_f8 = 1.0f / D_00E38F38[lolo.bp_04->f_02_vert2idx][3];
					MK_VERTEX_0(&(D_00E2BBD8[lolo.bp_84]->f_70.asVertex[2]), lolo.bp_fc, D_00E38F38[lolo.bp_04->f_02_vert2idx][0] * lolo.bp_f8, D_00E38F38[lolo.bp_04->f_02_vert2idx][1] * lolo.bp_f8, D_00E38F38[lolo.bp_04->f_02_vert2idx][2] * lolo.bp_f8, lolo.bp_f8, lolo.vcolor_2.rgba, lolo.u_2, lolo.v_2);
				}
			}
		}
//007607FA
...
int C_0076085F(struct t_wm_local_0c_TRIANGLE *bp08, struct SVECTOR *bp0c, int *bp10) {
	struct {
	...
	lolo.local_6 = /*lolo.local_17*/(float)bp0c->f_00_X;
	lolo.local_5 = /*lolo.local_18*/(float)bp0c->f_02_Y;
	lolo.local_4 = /*lolo.local_19*/(float)bp0c->f_04_Z;
	lolo.local_16[1] =
	lolo.local_3[1] = 0;
	lolo.local_16[0] = D_00E38338[bp08->f_01_vert1idx].f_00 - D_00E38338[bp08->f_00_vert0idx].f_00;
	lolo.local_16[2] = D_00E38338[bp08->f_01_vert1idx].f_08 - D_00E38338[bp08->f_00_vert0idx].f_08;
	lolo.local_3[2] = lolo.local_4 - D_00E38338[bp08->f_00_vert0idx].f_08;
	lolo.local_3[0] = lolo.local_6 - D_00E38338[bp08->f_00_vert0idx].f_00;
	...
	lolo.local_16[0] = D_00E38338[bp08->f_02_vert2idx].f_00 - D_00E38338[bp08->f_01_vert1idx].f_00;
	lolo.local_16[2] = D_00E38338[bp08->f_02_vert2idx].f_08 - D_00E38338[bp08->f_01_vert1idx].f_08;
	lolo.local_3[2] = lolo.local_4 - D_00E38338[bp08->f_01_vert1idx].f_08;
	lolo.local_3[0] = lolo.local_6 - D_00E38338[bp08->f_01_vert1idx].f_00;
	lolo.local_9[1] = lolo.local_16[2] * lolo.local_3[0] - lolo.local_16[0] * lolo.local_3[2];
	if(C_0075F090(lolo.local_9[1]) > 0)
		goto C_00760C52;//00760C5C
	lolo.local_16[0] = D_00E38338[bp08->f_00_vert0idx].f_00 - D_00E38338[bp08->f_02_vert2idx].f_00;
	lolo.local_16[2] = D_00E38338[bp08->f_00_vert0idx].f_08 - D_00E38338[bp08->f_02_vert2idx].f_08;
	lolo.local_3[2] = lolo.local_4 - D_00E38338[bp08->f_02_vert2idx].f_08;
	lolo.local_3[0] = lolo.local_6 - D_00E38338[bp08->f_02_vert2idx].f_00;
	lolo.local_9[1] = lolo.local_16[2] * lolo.local_3[0] - lolo.local_16[0] * lolo.local_3[2];
	if(C_0075F090(lolo.local_9[1]) > 0)
		goto C_00760C52;//00760C5A
	lolo.local_16[0] = D_00E38338[bp08->f_01_vert1idx].f_00 - D_00E38338[bp08->f_00_vert0idx].f_00;
	lolo.local_16[1] = D_00E38338[bp08->f_01_vert1idx].f_04 - D_00E38338[bp08->f_00_vert0idx].f_04;
	lolo.local_3[0] = D_00E38338[bp08->f_02_vert2idx].f_00 - D_00E38338[bp08->f_00_vert0idx].f_00;
	lolo.local_3[1] = D_00E38338[bp08->f_02_vert2idx].f_04 - D_00E38338[bp08->f_00_vert0idx].f_04;
	lolo.local_16[2] = D_00E38338[bp08->f_01_vert1idx].f_08 - D_00E38338[bp08->f_00_vert0idx].f_08;
	lolo.local_3[2] = D_00E38338[bp08->f_02_vert2idx].f_08 - D_00E38338[bp08->f_00_vert0idx].f_08;
	C_00760C64(lolo.local_16, lolo.local_3, lolo.local_9);
	lolo.local_9[1] *= (1.0f/256.0f);
	if(C_0075F090(lolo.local_9[1]) == 0)
		goto C_00760BFC;//00760C58
	lolo.local_10 = lolo.local_9[1] * D_00E38338[bp08->f_00_vert0idx].f_04;
	lolo.local_9[0] *= 1.0f/256.0f;
	lolo.local_11 = D_00E38338[bp08->f_00_vert0idx].f_00 - lolo.local_6;
	lolo.local_11 *= lolo.local_9[0];
	lolo.local_9[2] *= 1.0f/256.0f;
	lolo.local_12 = D_00E38338[bp08->f_00_vert0idx].f_08 - lolo.local_4;
...
C_00760BFC:
	lolo.local_10 = D_00E38338[bp08->f_00_vert0idx].f_04 + D_00E38338[bp08->f_01_vert1idx].f_04 + D_00E38338[bp08->f_02_vert2idx].f_04;
...
void C_00760E1D(struct t_wm_local_0c_TRIANGLE *bp08, struct t_wm_local_0c_TRIANGLE *bp0c, int bp10) {
	struct {
		int local_3;
		int local_2;
	...
	while(lolo.local_1 != bp0c) {
		lolo.local_2 = (lolo.local_1->f_04_u0 + lolo.local_1->f_06_u1 + lolo.local_1->f_08_u2) / 3;
		lolo.local_3 = (lolo.local_1->f_05_v0 + lolo.local_1->f_07_v1 + lolo.local_1->f_09_v2) / 3;

		if(lolo.local_2 < lolo.local_1->f_04_u0)
			lolo.local_1->f_04_u0 -= bp10;
		else
			lolo.local_1->f_04_u0 += bp10;
		if(lolo.local_2 < lolo.local_1->f_06_u1)
			lolo.local_1->f_06_u1 -= bp10;
		else
			lolo.local_1->f_06_u1 += bp10;
		if(lolo.local_2 < lolo.local_1->f_08_u2)
			lolo.local_1->f_08_u2 -= bp10;
		else
			lolo.local_1->f_08_u2 += bp10;

		if(lolo.local_3 < lolo.local_1->f_05_v0)
			lolo.local_1->f_05_v0 -= bp10;
		else
			lolo.local_1->f_05_v0 += bp10;
		if(lolo.local_3 < lolo.local_1->f_07_v1)
			lolo.local_1->f_07_v1 -= bp10;
		else
			lolo.local_1->f_07_v1 += bp10;
		if(lolo.local_3 < lolo.local_1->f_09_v2)
			lolo.local_1->f_09_v2 -= bp10;
		else
			lolo.local_1->f_09_v2 += bp10;
		lolo.local_1 ++;
	}
