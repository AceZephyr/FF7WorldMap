...
struct t_wm_local_0c_qqq {
	...
	struct t_wm_local_0c_TRIANGLE *f_04;
	unsigned char f_08;
	char __9[3];
};
////////////////////////////////////////
...
int D_00E29F40_ZOLOM_IS_INIT_PROBABLY;
int D_00E29F44;
short D_00E29F48;
struct VECTOR D_00E29F50[3];
struct USVECTOR D_00E29F80_ZOLOM_SEG[0x30];
int D_00E2A100[3];
short D_00E2A10C_ZOLOM_IDLE_TIMER;
int D_00E2A110;
int D_00E2A114;
short D_00E2A118;
//00E2A11C
...
//00E2A130
int D_00E2A134;
int D_00E2A138_RNGIDX;
int D_00E2A13C;
int D_00E2A140;
//00E2A144
struct t_wm_local_08_MESHHEADER D_00E2A148[6];
struct t_wm_local_0c_qqq *D_00E2A178;
//00E2A17C
int D_00E2A180[3];
struct USVECTOR *D_00E2A18C_ZOLOM_SEG_PTR;
...
unsigned char D_00E2B550_RNGBUF[0x209];
short D_00E2B75C;
int D_00E2B760;
int D_00E2B764;
int D_00E2B768[3];
...
void C_00753B73_RNGSHUFFLE(void);

//wm:randomize
void C_00753A01_RNGSEED(int bp08) {
	struct {//x830
		int j;//local_524
		int i;//local_523
	...
	for(lolo.i = 0; lolo.i < 0x209; lolo.i ++)
		D_00E2B550_RNGBUF[lolo.i] = lolo.local_522[lolo.i];
	C_00753B73_RNGSHUFFLE();
	C_00753B73_RNGSHUFFLE();
	C_00753B73_RNGSHUFFLE();
	D_00E2A138_RNGIDX = 0x208;
}

void C_00753B73_RNGSHUFFLE() {
	int i;

	for(i = 0; i < 0x20; i ++)
		D_00E2B550_RNGBUF[i] ^= D_00E2B550_RNGBUF[i + 0x1e9];
	for(i = 0x20; i < 0x209; i ++)
		D_00E2B550_RNGBUF[i] ^= D_00E2B550_RNGBUF[i - 0x20];
}

//wm:random?
int C_00753BE8_RAND() {
	if(++ D_00E2A138_RNGIDX >= 0x209) {
		C_00753B73_RNGSHUFFLE();
		D_00E2A138_RNGIDX = 0;
	}

	return D_00E2B550_RNGBUF[D_00E2A138_RNGIDX];
}
...
int C_00753C23(struct VECTOR *bp08, struct VECTOR *bp0c) {
	...
	lolo.local_1 = inline_abs(bp08->f_00_X - bp0c->f_00_X);
	if(lolo.local_1 >= 0x24000)
		lolo.local_1 = 0x48000 - lolo.local_1;
	lolo.local_2 = inline_abs(bp08->f_04_Y - bp0c->f_04_Y);
	lolo.local_3 = inline_abs(bp08->f_08_Z - bp0c->f_08_Z);
...
void C_00753D00(struct SVECTOR *bp08, short bp0c) {
	...
	if(bp08) {
		lolo.local_15.f_00_X =
		lolo.local_15.f_04_Y =
		lolo.local_15.f_08_Z = 0;
		lolo.local_2.f_00_X =
		lolo.local_2.f_04_Z = 0;
		lolo.local_2.f_02_Y = bp0c;
		...
		bp08->f_00_X = lolo.local_15.f_00_X;
		bp08->f_02_Y = lolo.local_15.f_04_Y;
		bp08->f_04_Z = lolo.local_15.f_08_Z;
	}
}
...
short C_00753F2E(struct VECTOR *bp08, struct VECTOR *bp0c) {
	return C_00753DA9(bp0c->f_00_X - bp08->f_00_X, bp0c->f_08_Z - bp08->f_08_Z);
}
...
void C_00754100(short bp08) {
	...
	lolo.local_46.f_00_X = 0;
	lolo.local_46.f_02_Y = -D_00DE6A04;
	lolo.local_46.f_04_Z = -0x4000;
	...
	lolo.local_9.f_00_X =
	lolo.local_9.f_02_Y = 0;
	lolo.local_9.f_04_Z = C_0074D319();
	psx_RotMatrixXYZ(&lolo.local_9, &lolo.local_56);
	psx_SetRotMatrix(&lolo.local_56);
	lolo.local_60.f_00_X = D_00E2C424 + 0xa0;
	lolo.local_60.f_04_Y = lolo.local_48;
	lolo.local_60.f_08_Z = 0;
	psx_TransMatrix(&lolo.local_56, &lolo.local_60);
	psx_SetTransMatrix(&lolo.local_56);
	lolo.local_46.f_04_Z = 0;

	lolo.local_46.f_00_X = -0xb4;
	lolo.local_46.f_02_Y = -lolo.local_48 - 0x18;
	psx_RotTrans(&lolo.local_46, &lolo.local_60, &lolo.local_28);
	lolo.local_27->x0 = lolo.local_60.f_00_X * D_00DE69D8;
	lolo.local_27->y0 = lolo.local_60.f_04_Y * D_00DE69D8;

	lolo.local_46.f_00_X = 0xb4;
	lolo.local_46.f_02_Y = -lolo.local_48 - 0x18;
	psx_RotTrans(&lolo.local_46, &lolo.local_60, &lolo.local_28);
	lolo.local_27->x1 = lolo.local_60.f_00_X * D_00DE69D8;
	lolo.local_27->y1 = lolo.local_60.f_04_Y * D_00DE69D8;

	lolo.local_46.f_00_X = -0xb4;
	lolo.local_46.f_02_Y = 0;
	psx_RotTrans(&lolo.local_46, &lolo.local_60, &lolo.local_28);
	lolo.local_27->x2 = lolo.local_60.f_00_X * D_00DE69D8;
	lolo.local_27->y2 = lolo.local_60.f_04_Y * D_00DE69D8;

	lolo.local_46.f_00_X = 0xb4;
	lolo.local_46.f_02_Y = 0;
	psx_RotTrans(&lolo.local_46, &lolo.local_60, &lolo.local_28);
	lolo.local_27->x3 = lolo.local_60.f_00_X * D_00DE69D8;
	lolo.local_27->y3 = lolo.local_60.f_04_Y * D_00DE69D8;
}
...
void C_007547A6(short bp08) {
	...
	if(lolo.local_6) {//else 00754E0C
		...
		D_00E2BBA4 &= 0xfff;
		lolo.local_30[0].f_00_X =
		lolo.local_30[1].f_00_X = -0xa0;
		lolo.local_30[2].f_00_X =
		lolo.local_30[3].f_00_X = D_00E28F20 - 0x160;
		lolo.local_30[4].f_00_X =
		lolo.local_30[5].f_00_X = D_00E28F20 - 0x60;
		lolo.local_30[6].f_00_X =
		lolo.local_30[7].f_00_X = 0xa0;
		lolo.local_30[0].f_02_Y =
		lolo.local_30[2].f_02_Y =
		lolo.local_30[4].f_02_Y =
		lolo.local_30[6].f_02_Y = lolo.local_31 - 0x40;
		lolo.local_30[1].f_02_Y =
		lolo.local_30[3].f_02_Y =
		lolo.local_30[5].f_02_Y =
		lolo.local_30[7].f_02_Y = lolo.local_31;
		lolo.local_30[8].f_00_X =
		lolo.local_30[9].f_00_X = (((-bp08 << 0x14) >> 0x14) * (lolo.local_34 - 0x1f4)) / 0x2710 - 0x48;
		lolo.local_30[0xa].f_00_X =
		lolo.local_30[0xb].f_00_X = lolo.local_30[8].f_00_X + 0x90;
		lolo.local_30[8].f_02_Y =
		lolo.local_30[0xa].f_02_Y = lolo.local_31 - 0x70;
		lolo.local_30[9].f_02_Y =
		lolo.local_30[0xb].f_02_Y = lolo.local_31 - 0x30;
		lolo.local_4.f_00_X = 
		lolo.local_4.f_02_Y = 0;
		lolo.local_4.f_04_Z = C_0074D319();
		...
		if(D_00E28F20 < 0xC0) {//else 00754B38
			lolo.local_1->f_00.x0 = lolo.local_90[0].f_00_X;
			lolo.local_1->f_00.x2 = lolo.local_90[1].f_00_X;
			lolo.local_1->f_00.x1 = lolo.local_90[4].f_00_X;
			lolo.local_1->f_00.x3 = lolo.local_90[5].f_00_X;
			lolo.local_1->f_00.y0 = lolo.local_90[0].f_04_Y;
			lolo.local_1->f_00.y2 = lolo.local_90[1].f_04_Y;
			lolo.local_1->f_00.y1 = lolo.local_90[4].f_04_Y;
			lolo.local_1->f_00.y3 = lolo.local_90[5].f_04_Y;
			...
			lolo.local_1->f_00.x0 = lolo.local_90[0].f_00_X;
			lolo.local_1->f_00.x2 = lolo.local_90[1].f_00_X;
			lolo.local_1->f_00.x1 = lolo.local_90[2].f_00_X;
			lolo.local_1->f_00.x3 = lolo.local_90[3].f_00_X;
			lolo.local_1->f_00.y0 = lolo.local_90[0].f_04_Y;
			lolo.local_1->f_00.y2 = lolo.local_90[1].f_04_Y;
			lolo.local_1->f_00.y1 = lolo.local_90[2].f_04_Y;
			lolo.local_1->f_00.y3 = lolo.local_90[3].f_04_Y;
			lolo.local_1->f_00.u0 =
			...
			C_00754493(lolo.local_1);
			lolo.local_1 ++;
			lolo.local_1->f_00.x0 = lolo.local_90[2].f_00_X;
			lolo.local_1->f_00.x2 = lolo.local_90[3].f_00_X;
			lolo.local_1->f_00.x1 = lolo.local_90[4].f_00_X;
			lolo.local_1->f_00.x3 = lolo.local_90[5].f_00_X;
			lolo.local_1->f_00.y0 = lolo.local_90[2].f_04_Y;
			lolo.local_1->f_00.y2 = lolo.local_90[3].f_04_Y;
			lolo.local_1->f_00.y1 = lolo.local_90[4].f_04_Y;
			lolo.local_1->f_00.y3 = lolo.local_90[5].f_04_Y;
		...
		lolo.local_1 ++;
		lolo.local_1->f_00.x0 = lolo.local_90[4].f_00_X;
		lolo.local_1->f_00.x2 = lolo.local_90[5].f_00_X;
		lolo.local_1->f_00.x1 = lolo.local_90[6].f_00_X;
		lolo.local_1->f_00.x3 = lolo.local_90[7].f_00_X;
		lolo.local_1->f_00.y0 = lolo.local_90[4].f_04_Y;
		lolo.local_1->f_00.y2 = lolo.local_90[5].f_04_Y;
		lolo.local_1->f_00.y1 = lolo.local_90[6].f_04_Y;
		lolo.local_1->f_00.y3 = lolo.local_90[7].f_04_Y;
		lolo.local_1->f_00.u2 = 0;
		lolo.local_1->f_00.u0 = 0;
		lolo.local_1->f_00.u1 =
		lolo.local_1->f_00.u3 = 0xff - D_00E28F20;
		C_00754493(lolo.local_1);
		if(D_00E2AAE4 && lolo.local_90[0xa].f_00_X > D_00E2C424 && lolo.local_90[8].f_00_X < D_00E2C428 + 0x140) {
			lolo.local_91 = &D_00969B98;
			lolo.local_91->f_00.x0 = lolo.local_90[8].f_00_X;
			lolo.local_91->f_00.y0 = lolo.local_90[8].f_04_Y;
			lolo.local_91->f_00.x2 = lolo.local_90[9].f_00_X;
			lolo.local_91->f_00.y2 = lolo.local_90[9].f_04_Y;
			lolo.local_91->f_00.x1 = lolo.local_90[0xa].f_00_X;
			lolo.local_91->f_00.y1 = lolo.local_90[0xa].f_04_Y;
			lolo.local_91->f_00.x3 = lolo.local_90[0xb].f_00_X;
			lolo.local_91->f_00.y3 = lolo.local_90[0xb].f_04_Y;
...
void C_00754E1D() {
	...
	for(local_1 = 0; local_1 < 0x10; local_1 ++) {
		...
		D_00E28CE0[local_1].f_00.f_04_Y = 0;
	}
	D_00E2BB94 = 0;
	C_00754E6B();
}
...
void C_00754EEF(int bp08, int bp0c) {
	if(D_00E2BB94 && bp08 >= 0 && bp08 < 0x24 && bp0c >= 0 && bp0c < 0x1c) {
		D_00E2BB94->f_00.f_00_X &= 0x1fff;
		D_00E2BB94->f_00.f_08_Z &= 0x1fff;
		D_00E2BB94->f_00.f_00_X |= bp08 << 0xd;
		D_00E2BB94->f_00.f_08_Z |= bp0c << 0xd;
	}
}
...
void C_00754F72(int bp08, int bp0c) {
	if(D_00E2BB94) {
		D_00E2BB94->f_00.f_00_X &= ~0x1fff;
		D_00E2BB94->f_00.f_08_Z &= ~0x1fff;
		D_00E2BB94->f_00.f_00_X |= bp08 & 0x1fff;
		D_00E2BB94->f_00.f_08_Z |= bp0c & 0x1fff;
	}
}
...
void C_00755C40() {
	...
	for(lolo.local_5 = 0;  lolo.local_5 < 0x100; lolo.local_5 ++)
		D_00E2A6E0[lolo.local_5] = C_00753BE8_RAND() << 2;
}
...
void C_00755CFF(int bp08) {
	...
	for(lolo.local_4 = (struct SVECTOR *)D_00E2AB50; lolo.local_4 < lolo.local_14; lolo.local_4 ++) {
		...
		lolo.local_9.f_00_X += lolo.local_3;
		lolo.local_9.f_04_Y += lolo.local_3;
		lolo.local_9.f_08_Z += lolo.local_3;
		*(lolo.local_10 ++) = ((lolo.local_9.f_00_X >> 0xa) & 0x1f) | ((lolo.local_9.f_04_Y >> 5) & 0x3e0) | (lolo.local_9.f_08_Z & 0x7c00);
	}
	lolo.local_13 =
	lolo.local_23 = 0xbb;
	lolo.local_12 = 0xff;
...
void C_00755F95() {
	...
	D_00E2A10C_ZOLOM_IDLE_TIMER =
	D_00E2BBBC = 0;
	D_00E2A114 =
	D_00E29F40_ZOLOM_IS_INIT_PROBABLY =
	D_00E2AB38 = 0;
	for(lolo.local_2 = 0; lolo.local_2 < 6; lolo.local_2 ++)
		D_00E2A148[lolo.local_2].f_00_triPtr = 0;
}

void C_00756138_INIT_ZOLOM_SEG_BUFFER(void);

void C_0075611B() {
	if(D_00E29F40_ZOLOM_IS_INIT_PROBABLY == 0) {
		C_00756138_INIT_ZOLOM_SEG_BUFFER();
		D_00E29F40_ZOLOM_IS_INIT_PROBABLY = 1;
	}
}

void C_00756138_INIT_ZOLOM_SEG_BUFFER() {
	struct {
		struct VECTOR local_5_playerpos;
		struct USVECTOR *local_1;
	}lolo;

	C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_5_playerpos);
	if(lolo.local_5_playerpos.f_08_Z < 0x23A98) {
		for(lolo.local_1 = D_00E29F80_ZOLOM_SEG; lolo.local_1 < &(D_00E29F80_ZOLOM_SEG[0x30])/*D_00E2A100*/; lolo.local_1 ++) {
	...
	D_00E2AAE0 = 0x400;
	D_00E2A18C_ZOLOM_SEG_PTR = D_00E29F80_ZOLOM_SEG;
}
...
int C_007562A9_PLAYER_IN_ZOLOM_RANGE(void);
...
void C_007561F6(struct t_wm_local_18 *bp08) {
	...
	if(C_007562A9_PLAYER_IN_ZOLOM_RANGE()) {
		lolo.local_4.f_00_X = D_00E2A18C_ZOLOM_SEG_PTR->f_00 + 0x34000;
		lolo.local_4.f_08_Z = D_00E2A18C_ZOLOM_SEG_PTR->f_02 + 0x20000;
		C_00750134(&lolo.local_4, &lolo.local_7, &lolo.local_5, &lolo.local_8);
		if(lolo.local_5 == bp08->f_10 && lolo.local_8 == bp08->f_12) {
			D_00E2A114 = C_0074CC07_updateObjMeshMaybe(bp08, &lolo.local_7, D_00E2A148, (short *)&(D_00E2A18C_ZOLOM_SEG_PTR->f_06), 0, 0, 0x64);
			if(D_00E2A114 == 0)
				D_00E2A18C_ZOLOM_SEG_PTR->f_06 = 0;
		}
	}
}

int C_007562A9_PLAYER_IN_ZOLOM_RANGE() {
	struct VECTOR playerpos;

	C_00762798_SET_VECTOR_TO_PLAYER_POS(&playerpos);

	return  (D_00E29F40_ZOLOM_IS_INIT_PROBABLY && playerpos.f_00_X >= 0x30000 && playerpos.f_00_X < 0x40000 && playerpos.f_08_Z >= 0x1c000 && playerpos.f_08_Z < 0x2c000)?1:0;
}

void C_007564CD_ZOLOM_TICK(void);
...
void C_007562FF() {
	...
	C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_5_playerpos);
	if(C_007562A9_PLAYER_IN_ZOLOM_RANGE()) {//else 00756470
		if(D_00E2A114 == 0) {//else 00756380
			D_00E2A18C_ZOLOM_SEG_PTR->f_00 = ((D_00E2A18C_ZOLOM_SEG_PTR->f_00 * 0x3f) + 0x2710) >> 6;
			D_00E2A18C_ZOLOM_SEG_PTR->f_02 = ((D_00E2A18C_ZOLOM_SEG_PTR->f_02 * 0x3f) + 0x3A98) >> 6;
			D_00E2AAE0 = D_00E2A18C_ZOLOM_SEG_PTR->f_04 + 0x800;
		}
		D_00E2A114 = 0;
		lolo.local_7 = inline_abs(lolo.local_5_playerpos.f_00_X - D_00E2A18C_ZOLOM_SEG_PTR->f_00 - 0x34000) + inline_abs(lolo.local_5_playerpos.f_08_Z - D_00E2A18C_ZOLOM_SEG_PTR->f_02 - 0x20000);
		if(lolo.local_7 > 0xc8 || (C_00761769_PLAYERMODEL_MASK(7) == 0 && C_00761844() == 0)) {
			// zolom frame
			C_007564CD_ZOLOM_TICK();
		} else {
			// you got hit by the zolom i think
			C_007640BC(7);
			D_00E29F40_ZOLOM_IS_INIT_PROBABLY = 0;
		}
		C_0075692A();
	}
	lolo.local_6 = C_00762136_PLAYER_GROUND_TYPE() & 0x1f;
	lolo.local_1 = C_00761735_PLAYER_CURRENT_MODEL();//current transportation mode?
	if(lolo.local_1 != D_00E2A12C)
		lolo.local_6 = D_00E2A110;
	D_00E2A12C = lolo.local_1;
	if(lolo.local_6 == 7 && D_00E2A110 == 0)
		D_00E2AB38 = lolo.local_5_playerpos.f_00_X > 0x36000;
	D_00E2A110 = lolo.local_6;
}

void C_007564CD_ZOLOM_TICK() {
	struct {
	...
	lolo.local_3.f_00_X =
	lolo.local_3.f_02_Y = 0;
	lolo.local_3.f_04_Z = 0x64;
	C_00753D00(&lolo.local_3, D_00E2AAE0);
	lolo.local_1 = D_00E2A18C_ZOLOM_SEG_PTR + 1;
	if(lolo.local_1 >= &(D_00E29F80_ZOLOM_SEG[0x30])/*D_00E2A100*/)
		lolo.local_1 = &(D_00E29F80_ZOLOM_SEG[0]);
	lolo.local_1->f_00 = D_00E2A18C_ZOLOM_SEG_PTR->f_00 + lolo.local_3.f_00_X;
	lolo.local_1->f_02 = D_00E2A18C_ZOLOM_SEG_PTR->f_02 + lolo.local_3.f_04_Z;
	lolo.local_1->f_04 = D_00E2AAE0;
	// ground type 7 is marsh
	if((C_00761769_PLAYERMODEL_MASK(7) || C_00761844()) && C_00762136_PLAYER_GROUND_TYPE() == 7) {//else 0075688A
		// the player is on marsh ground and is a player and not a chocobo?
		lolo.local_5 = 0;
		C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_9);
		lolo.local_9.f_00_X -= 0x34000;
		lolo.local_9.f_08_Z -= 0x20000;
		lolo.local_4 = /*lolo.local_12*/inline_abs((unsigned short)lolo.local_1->f_00 - lolo.local_9.f_00_X) + /*lolo.local_13*/inline_abs((unsigned short)lolo.local_1->f_02 - lolo.local_9.f_08_Z);
		lolo.local_11 = /*lolo.local_14*/(lolo.local_4 > 0x12c)?0x493e0 / lolo.local_4:0;
		lolo.local_3.f_00_X =
		lolo.local_3.f_02_Y = 0;
		lolo.local_3.f_04_Z = 0x64;
		C_00753D00(&lolo.local_3, D_00E2AAE0 + lolo.local_11);
		lolo.local_10 = /*lolo.local_15*/inline_abs(D_00E2A18C_ZOLOM_SEG_PTR->f_00 + lolo.local_3.f_00_X - lolo.local_9.f_00_X) + /*lolo.local_16*/inline_abs(D_00E2A18C_ZOLOM_SEG_PTR->f_02 + lolo.local_3.f_04_Z  - lolo.local_9.f_08_Z);
		...
		lolo.local_3.f_04_Z = 0x64;
		C_00753D00(&lolo.local_3, D_00E2AAE0 - lolo.local_11);
		lolo.local_10 = /*lolo.local_17*/inline_abs(D_00E2A18C_ZOLOM_SEG_PTR->f_00 + lolo.local_3.f_00_X - lolo.local_9.f_00_X) + /*lolo.local_18*/inline_abs(D_00E2A18C_ZOLOM_SEG_PTR->f_02 + lolo.local_3.f_04_Z - lolo.local_9.f_08_Z);
		if(lolo.local_10 < lolo.local_4) {
			lolo.local_1->f_00 = D_00E2A18C_ZOLOM_SEG_PTR->f_00 + lolo.local_3.f_00_X;
			lolo.local_1->f_02 = D_00E2A18C_ZOLOM_SEG_PTR->f_02 + lolo.local_3.f_04_Z;
			lolo.local_1->f_04 = D_00E2AAE0 - lolo.local_11;
	...
	} else if(D_00E2A10C_ZOLOM_IDLE_TIMER -- <= 0) {
		D_00E2A10C_ZOLOM_IDLE_TIMER = (C_00753BE8_RAND() + 0x40) >> 2;
		D_00E2BBBC = (C_00753BE8_RAND() - 0x80) >> 2;
	}
	D_00E2A18C_ZOLOM_SEG_PTR = lolo.local_1;
...
void C_0075692A() {
	...
	lolo.local_5 = D_00E2A18C_ZOLOM_SEG_PTR - 1;
	if(lolo.local_5 < &(D_00E29F80_ZOLOM_SEG[0]))
		lolo.local_5 = &(D_00E29F80_ZOLOM_SEG[0x2f]);//D_00E2A0F8
	for(lolo.local_6 = &(D_00E2A490[0]); lolo.local_6 < &(D_00E2A490[0xc])/*00E2A6D0*/; lolo.local_6 ++) {
		lolo.local_5 += 4;
		if(lolo.local_5 >= &(D_00E29F80_ZOLOM_SEG[0x30])/*D_00E2A100*/)
			lolo.local_5 -= 0x30;
		if(C_00753366((lolo.local_5->f_00 >> 0xd) + 0x1a, ((lolo.local_5->f_02) >> 0xd) + 0x10)) {//else 00756A8B
			lolo.local_8 = lolo.local_5->f_00 + 0x34000 - lolo.local_4.f_00_X;
			if(lolo.local_8 < -0x7530 || lolo.local_8 > 0x7530)
				continue;
			lolo.local_6->f_00.pad1 = lolo.local_8;
			lolo.local_8 = lolo.local_5->f_02 + 0x20000 - lolo.local_4.f_08_Z;
			if(lolo.local_8 < -0x7530 || lolo.local_8 > 0x7530)
				continue;
...
void C_00756B0C(struct t_wm_local_18 *bp08) {
	struct {
		int bp_0c;
		struct t_wm_local_0c_TRIANGLE *bp_08;
	...
	if(D_00E2B764 && bp08 && D_00E2BB80 == bp08->f_10 && D_00E2BB8C == bp08->f_12) {//else 00756F31
		C_00756F45(bp08);
		if(
			C_0074CC07_updateObjMeshMaybe(bp08, &D_00E28F38, 0, &lolo.bp_04, &lolo.bp_08, 0, 0) &&
			(lolo.bp_08->f_0b & 0x40) == 0 &&
			(lolo.bp_08->f_03_walkability & 0xe0) != 0xe0 &&
			BIT_ISSET_2(0x321B6F83, lolo.bp_08->f_03_walkability)
		) {//else 00756F27
			D_00E2BB90 ++;
			if(D_00E2BB90 < &(D_00E2A190[0x28])/*00E2A370*/) {//else 00756F1B
				...
				switch(D_00E2B764) {
					case 1:
						if(bp08->f_08[lolo.bp_08->f_00_vert0idx].f_00_X > 0x1ff6 && bp08->f_08[lolo.bp_08->f_01_vert1idx].f_00_X > 0x1ff6)
							lolo.bp_0c = 1;
						else if(bp08->f_08[lolo.bp_08->f_01_vert1idx].f_00_X > 0x1ff6 && bp08->f_08[lolo.bp_08->f_02_vert2idx].f_00_X > 0x1ff6)
							lolo.bp_0c = 2;
						else if(bp08->f_08[lolo.bp_08->f_02_vert2idx].f_00_X > 0x1ff6 && bp08->f_08[lolo.bp_08->f_00_vert0idx].f_00_X > 0x1ff6)
							lolo.bp_0c = 4;
					break;
					case 2:
						if(bp08->f_08[lolo.bp_08->f_00_vert0idx].f_04_Z > 0x1ff6 && bp08->f_08[lolo.bp_08->f_01_vert1idx].f_04_Z > 0x1ff6)
							lolo.bp_0c = 1;
						else if(bp08->f_08[lolo.bp_08->f_01_vert1idx].f_04_Z > 0x1ff6 && bp08->f_08[lolo.bp_08->f_02_vert2idx].f_04_Z > 0x1ff6)
							lolo.bp_0c = 2;
						else if(bp08->f_08[lolo.bp_08->f_02_vert2idx].f_04_Z > 0x1ff6 && bp08->f_08[lolo.bp_08->f_00_vert0idx].f_04_Z > 0x1ff6)
							lolo.bp_0c = 4;
					break;
					case 3:
						if(bp08->f_08[lolo.bp_08->f_00_vert0idx].f_00_X < 0xa && bp08->f_08[lolo.bp_08->f_01_vert1idx].f_00_X < 0xa)
							lolo.bp_0c = 1;
						else if(bp08->f_08[lolo.bp_08->f_01_vert1idx].f_00_X < 0xa && bp08->f_08[lolo.bp_08->f_02_vert2idx].f_00_X < 0xa)
							lolo.bp_0c = 2;
						else if(bp08->f_08[lolo.bp_08->f_02_vert2idx].f_00_X < 0xa && bp08->f_08[lolo.bp_08->f_00_vert0idx].f_00_X < 0xa)
							lolo.bp_0c = 4;
					break;
					case 4:
						if(bp08->f_08[lolo.bp_08->f_00_vert0idx].f_04_Z < 0xa && bp08->f_08[lolo.bp_08->f_01_vert1idx].f_04_Z < 0xa)
							lolo.bp_0c = 1;
						else if(bp08->f_08[lolo.bp_08->f_01_vert1idx].f_04_Z < 0xa && bp08->f_08[lolo.bp_08->f_02_vert2idx].f_04_Z < 0xa)
							lolo.bp_0c = 2;
						else if(bp08->f_08[lolo.bp_08->f_02_vert2idx].f_04_Z < 0xa && bp08->f_08[lolo.bp_08->f_00_vert0idx].f_04_Z < 0xa)
							lolo.bp_0c = 4;
					break;
				}
				if(lolo.bp_0c == 0)
...
void C_00756F45(struct t_wm_local_18 *bp08) {
	...
	struct t_wm_local_0c_TRIANGLE *local_2;
...
void C_00756FF9(struct t_wm_local_18 *bp08, struct t_wm_local_0c_TRIANGLE *bp0c) {
	struct VECTOR local_4;
	...
	if(D_00E2BB88 == 0 || D_00E2BB88 == 2 || D_00E2BB88 == 3) {
		...
		D_00E36110 = 0;
		D_00E2BB88 = 1;
		C_00762798_SET_VECTOR_TO_PLAYER_POS(&local_4);
		D_00E2AB3C = /*local_5*/(local_4.f_00_X >= 0x36000 && local_4.f_00_X < 0x40000 && local_4.f_08_Z >= 0x1c000 && local_4.f_08_Z < 0x26000);
	}
}
...
void C_00757260(struct t_wm_local_0c_qqq *bp08, struct VECTOR *bp0c) {
	struct t_wm_local_0c_TRIANGLE *local_1;
	struct SVECTOR *local_2;

	if(bp0c) {
		local_1 = bp08->f_04;
		local_2 = bp08->f_00->f_08;
		bp0c->f_00_X = (local_2[local_1->f_00_vert0idx].f_00_X + local_2[local_1->f_01_vert1idx].f_00_X + local_2[local_1->f_02_vert2idx].f_00_X) / 3 + (bp08->f_00->f_10 << 0xd);
		bp0c->f_04_Y = 0;
		bp0c->f_08_Z = (local_2[local_1->f_00_vert0idx].f_04_Z + local_2[local_1->f_01_vert1idx].f_04_Z + local_2[local_1->f_02_vert2idx].f_04_Z) / 3 + (bp08->f_00->f_12 << 0xd);
	}
}
...
void C_0075749E() {
	struct {
		struct t_wm_local_0c_TRIANGLE *bp_0c;
		int bp_08;
		int bp_04;
	}lolo;
	...
	if(D_00E2BB90 && D_00E2B764 == 0 && (D_00E36110 == 0 || D_00E2AB3C)) {//else 0075777B
		...
		switch(D_00E2BB90->f_08 & 7) {
			case 0:
				...
				switch(lolo.bp_04) {
					case 1: lolo.bp_08 = C_0075783C(lolo.bp_0c->f_00_vert0idx, lolo.bp_0c->f_01_vert1idx); break;
					case 2: lolo.bp_08 = C_0075783C(lolo.bp_0c->f_01_vert1idx, lolo.bp_0c->f_02_vert2idx); break;
					case 4: lolo.bp_08 = C_0075783C(lolo.bp_0c->f_02_vert2idx, lolo.bp_0c->f_00_vert0idx); break;
				}
			break;
			case 6:
				D_00E2BB90->f_08 = 7;
				lolo.bp_08 = C_0075783C(lolo.bp_0c->f_00_vert0idx, lolo.bp_0c->f_01_vert1idx);
			break;
			case 5:
				D_00E2BB90->f_08 = 7;
				lolo.bp_08 = C_0075783C(lolo.bp_0c->f_01_vert1idx, lolo.bp_0c->f_02_vert2idx);
			break;
			case 3:
				D_00E2BB90->f_08 = 7;
				lolo.bp_08 = C_0075783C(lolo.bp_0c->f_02_vert2idx, lolo.bp_0c->f_00_vert0idx);
			break;
			case 4:
				if(C_00757CD4(lolo.bp_0c->f_00_vert0idx, lolo.bp_0c->f_01_vert1idx, lolo.bp_0c->f_02_vert2idx)) {
					D_00E2BB90->f_08 = 5;
					lolo.bp_08 = C_0075783C(lolo.bp_0c->f_00_vert0idx, lolo.bp_0c->f_01_vert1idx);
				} else {
					D_00E2BB90->f_08 = 6;
			...
			break;
			case 1:
				if(C_00757CD4(lolo.bp_0c->f_01_vert1idx, lolo.bp_0c->f_02_vert2idx, lolo.bp_0c->f_00_vert0idx)) {
					D_00E2BB90->f_08 = 3;
					lolo.bp_08 = C_0075783C(lolo.bp_0c->f_01_vert1idx, lolo.bp_0c->f_02_vert2idx);
				} else {
					D_00E2BB90->f_08 = 5;
			...
			break;
			case 2:
				if(C_00757CD4(lolo.bp_0c->f_02_vert2idx, lolo.bp_0c->f_00_vert0idx, lolo.bp_0c->f_01_vert1idx)) {
					D_00E2BB90->f_08 = 6;
					lolo.bp_08 = C_0075783C(lolo.bp_0c->f_02_vert2idx, lolo.bp_0c->f_00_vert0idx);
				} else {
					D_00E2BB90->f_08 = 3;
...
int C_0075783C(unsigned char bp08, unsigned char bp0c) {
	...
	for(lolo.local_3 = 0, lolo.local_1 = D_00E2BB90->f_00->f_04; lolo.local_1 < &(D_00E2BB90->f_00->f_04[D_00E2BB90->f_00->f_14]) && lolo.local_3 == 0; lolo.local_1 ++) {
		if(lolo.local_1 != D_00E2BB90->f_04) {//else 007579B5
			if(
				(bp08 == lolo.local_1->f_00_vert0idx && bp0c == lolo.local_1->f_01_vert1idx) ||
				(bp08 == lolo.local_1->f_01_vert1idx && bp0c == lolo.local_1->f_00_vert0idx)
			) {
				lolo.local_3 = 1;
			} else if(
				(bp08 == lolo.local_1->f_01_vert1idx && bp0c == lolo.local_1->f_02_vert2idx) ||
				(bp08 == lolo.local_1->f_02_vert2idx && bp0c == lolo.local_1->f_01_vert1idx)
			) {
				lolo.local_3 = 2;
			} else if(
				(bp08 == lolo.local_1->f_02_vert2idx && bp0c == lolo.local_1->f_00_vert0idx) ||
				(bp08 == lolo.local_1->f_00_vert0idx && bp0c == lolo.local_1->f_02_vert2idx)
			) {
				lolo.local_3 = 4;
			}
		}
	...
	if(lolo.local_3) {//else 00757A7D
		if(
			...
			(lolo.local_1->f_03_walkability & 0xe0) != 0xe0 &&
			BIT_ISSET_2(0x321B6F83, lolo.local_1->f_03_walkability)
		) {//else 00757A71
		...
		if(D_00E2BB90 < &(D_00E2A190[0x27])/*00E2A364*/) {//else 00757CC6
			lolo.local_5 = D_00E2BB90->f_00->f_08[bp08].f_00_X;
			lolo.local_7 = D_00E2BB90->f_00->f_08[bp08].f_04_Z;
			lolo.local_6 = D_00E2BB90->f_00->f_08[bp0c].f_00_X;
			lolo.local_4 = D_00E2BB90->f_00->f_08[bp0c].f_04_Z;
			...
			if(lolo.local_5 < 0xa && lolo.local_6 < 0xa) {//else 00757B92
				...
				if(D_00E2BB80 < 0)
					D_00E2BB80 = 0x23;
				D_00E28F38.f_00_X = 0x1ff6;
				D_00E28F38.f_04_Z = (lolo.local_7 + lolo.local_4) >> 1;
				D_00E2B764 = 1;
				//goto 00757CC4
				...
				if(D_00E2BB8C < 0)
					D_00E2BB8C = 0x1B;
				D_00E28F38.f_00_X = (lolo.local_5 + lolo.local_6) >> 1;
				D_00E28F38.f_04_Z = 0x1ff6;
				D_00E2B764 = 2;
				//goto 00757CC4
...
int C_00757CD4(unsigned char bp08, unsigned char bp0c, unsigned char bp10) {
	...
	if(D_00E2AB3C) {//else 00758000
		lolo.local_4.f_00_X = 0x3A681;
		lolo.local_4.f_08_Z = 0x2195F;
		return
			/*lolo.local_6*/inline_abs(lolo.local_4.f_00_X - ((lolo.local_5[bp08].f_00_X + lolo.local_5[bp0c].f_00_X) >> 1) - (D_00E2BB90->f_00->f_10 << 0xd)) + /*lolo.local_7*/inline_abs(lolo.local_4.f_08_Z - ((lolo.local_5[bp08].f_04_Z + lolo.local_5[bp0c].f_04_Z) >> 1) - (D_00E2BB90->f_00->f_12 << 0xd))
		<
			/*lolo.local_8*/inline_abs(lolo.local_4.f_00_X - ((lolo.local_5[bp0c].f_00_X + lolo.local_5[bp10].f_00_X) >> 1) - (D_00E2BB90->f_00->f_10 << 0xd)) + /*lolo.local_9*/inline_abs(lolo.local_4.f_08_Z - ((lolo.local_5[bp0c].f_04_Z + lolo.local_5[bp10].f_04_Z) >> 1) - (D_00E2BB90->f_00->f_12 << 0xd))
		;
	} else {
		C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_4);
		return
			/*lolo.local_10*/inline_abs(lolo.local_4.f_00_X - ((lolo.local_5[bp08].f_00_X + lolo.local_5[bp0c].f_00_X) >> 1) - (D_00E2BB90->f_00->f_10 << 0xd)) + /*lolo.local_11*/inline_abs(lolo.local_4.f_08_Z - ((lolo.local_5[bp08].f_04_Z + lolo.local_5[bp0c].f_04_Z) >> 1) - (D_00E2BB90->f_00->f_12 << 0xd))
		>
			/*lolo.local_12*/inline_abs(lolo.local_4.f_00_X - ((lolo.local_5[bp0c].f_00_X + lolo.local_5[bp10].f_00_X) >> 1) - (D_00E2BB90->f_00->f_10 << 0xd)) + /*lolo.local_13*/inline_abs(lolo.local_4.f_08_Z - ((lolo.local_5[bp0c].f_04_Z + lolo.local_5[bp10].f_04_Z) >> 1) - (D_00E2BB90->f_00->f_12 << 0xd))
		;
	}
}
...
int C_00758313(struct t_wm_local_0c_qqq *bp08) {
	struct {
		...
		struct t_wm_local_0c_TRIANGLE *local_7;
		int local_6;
	...
	lolo.local_18.f_00_X = (lolo.local_8[lolo.local_7->f_00_vert0idx].f_00_X + lolo.local_8[lolo.local_7->f_01_vert1idx].f_00_X + lolo.local_8[lolo.local_7->f_02_vert2idx].f_00_X) / 3;
	lolo.local_18.f_08_Z = (lolo.local_8[lolo.local_7->f_00_vert0idx].f_04_Z + lolo.local_8[lolo.local_7->f_01_vert1idx].f_04_Z + lolo.local_8[lolo.local_7->f_02_vert2idx].f_04_Z) / 3;
	if(D_00E2AB3C) {//else 0075840C
		lolo.local_12.f_00_X = lolo.local_18.f_00_X + (bp08->f_00->f_10 << 0xd);
		lolo.local_12.f_08_Z = lolo.local_18.f_08_Z + (bp08->f_00->f_12 << 0xd);
		lolo.local_5.f_00_X = 0x3A681;
		lolo.local_5.f_08_Z = 0x2195F;
		lolo.local_13 = C_00753F2E(&lolo.local_12, &lolo.local_5);
	} else {
		lolo.local_13 = C_0074D298();
	}
	lolo.local_5.f_00_X = (lolo.local_8[lolo.local_7->f_00_vert0idx].f_00_X + lolo.local_8[lolo.local_7->f_01_vert1idx].f_00_X) >> 1;
	lolo.local_5.f_08_Z = (lolo.local_8[lolo.local_7->f_00_vert0idx].f_04_Z + lolo.local_8[lolo.local_7->f_01_vert1idx].f_04_Z) >> 1;
	...
	lolo.local_5.f_00_X = (lolo.local_8[lolo.local_7->f_01_vert1idx].f_00_X + lolo.local_8[lolo.local_7->f_02_vert2idx].f_00_X) >> 1;
	lolo.local_5.f_08_Z = (lolo.local_8[lolo.local_7->f_01_vert1idx].f_04_Z + lolo.local_8[lolo.local_7->f_02_vert2idx].f_04_Z) >> 1;
	...
	lolo.local_5.f_00_X = (lolo.local_8[lolo.local_7->f_02_vert2idx].f_00_X + lolo.local_8[lolo.local_7->f_00_vert0idx].f_00_X) >> 1;
	lolo.local_5.f_08_Z = (lolo.local_8[lolo.local_7->f_02_vert2idx].f_04_Z + lolo.local_8[lolo.local_7->f_00_vert0idx].f_04_Z) >> 1;
	lolo.local_1 = (C_00753F2E(&lolo.local_18, &lolo.local_5) - lolo.local_13) & 0xfff;
	if(lolo.local_1 >= 0x800)
		lolo.local_1 = 0x1000 - lolo.local_1;
	if(lolo.local_14 > lolo.local_1)
	...
	for(lolo.local_6 = 0; lolo.local_6 < 3; lolo.local_6 ++) {
		if(D_00E2AB40[lolo.local_6]) {//else 00758A29
			...
			if(D_00E2AB40[lolo.local_6] & 4) {//else 0075869A
				if(lolo.local_5.f_00_X == 0 && lolo.local_5.f_08_Z == 0) {//else 0075867E
				...
				if(D_00E2AB40[lolo.local_6] & 1) {//else 007587DD
					...
					if(D_00E28F28[lolo.local_6] > &(D_00E2A190[0]) && D_00E28F28[lolo.local_6] < D_00E2A178) {//else 007587AA
						...
						D_00E29F50[lolo.local_6].f_00_X = (lolo.local_12.f_00_X + D_00E29F50[lolo.local_6].f_00_X) >> 1;
						D_00E29F50[lolo.local_6].f_08_Z = (lolo.local_12.f_08_Z + D_00E29F50[lolo.local_6].f_08_Z) >> 1;
					}
					D_00E2BB98[lolo.local_6] = C_00753F2E(&lolo.local_5, &(D_00E29F50[lolo.local_6]));
					D_00E2A100[lolo.local_6] = 0x7fff;
				}
				lolo.local_8.f_00_X =
				lolo.local_8.f_02_Y = 0;
				lolo.local_8.f_04_Z = 0x78;
				C_00761B19(D_00E2BB98[lolo.local_6]);
				C_00753D00(&lolo.local_8, D_00E2BB98[lolo.local_6]);
				C_00762E87(lolo.local_8.f_00_X, lolo.local_8.f_04_Z);
				lolo.local_1 = /*lolo.local_15*/inline_abs(lolo.local_5.f_00_X - D_00E29F50[lolo.local_6].f_00_X) + /*lolo.local_16*/inline_abs(lolo.local_5.f_08_Z - D_00E29F50[lolo.local_6].f_08_Z);
				...
				if(D_00E2AB3C && /*lolo.local_20*/inline_abs(lolo.local_5.f_00_X - 0x3a681) + /*lolo.local_21*/inline_abs(lolo.local_5.f_08_Z - 0x2195f) < 0x7d0)
...
int C_00758B12(int bp08, int bp0c) {
	...
	if(D_00E28F24 <= 0) {
		D_00E28F24 =
		D_00E2A6D0 = C_00753BE8_RAND() + 0x80;
		D_00E2A118 = (C_00753BE8_RAND() >> 3) + 0x40;
		D_00E2B75C = ((C_00753BE8_RAND() & 2) - 1) << 4;
	}
	if(D_00E28F24 >= D_00E2A118 && bp0c) {//else 00758CDF
		...
		lolo.local_3.f_00_X =
		lolo.local_3.f_02_Y = 0;
		lolo.local_3.f_04_Z = 0x12c;
		C_00753D00(&lolo.local_3, -lolo.local_1);
		C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_7);
		lolo.local_7.f_00_X += lolo.local_3.f_00_X;
		lolo.local_7.f_08_Z += lolo.local_3.f_04_Z;
...
void C_00758DA5(short bp08, short bp0c) {
	...
	if(lolo.local_1 && lolo.local_1->f_06) {//else 00759138
		...
		D_00E2B760 ++;
		lolo.local_4.f_00_X = 0;
		lolo.local_4.f_02_Y = lolo.local_1->f_04;
		lolo.local_4.f_04_Z = (lolo.local_1->f_06 * psx_rsin(lolo.local_5)) >> 0x11;
		psx_RotMatrixXYZ(&lolo.local_4, &lolo.local_21);
		psx_SetRotMatrix(&lolo.local_21);
		lolo.local_10.f_00_X =
		lolo.local_10.f_08_Z = 0;
		lolo.local_10.f_04_Y = 0x4e20;
		...
		for(lolo.local_13 = &(lolo.local_1->f_08[0]); lolo.local_13 < &(lolo.local_1->f_08[0xc]) && *lolo.local_13 >= 0; lolo.local_13 ++) {
			...
			lolo.local_12.f_00_X = 0;
			lolo.local_12.f_02_Y = (short)lolo.local_26->f_04 - 0x4e20;
			lolo.local_12.f_04_Z = 0;
			psx_RotTrans(&lolo.local_12, &lolo.local_10, &lolo.local_2);
			lolo.local_26->f_00 += (float)lolo.local_10.f_00_X;
			lolo.local_26->f_04 = (float)lolo.local_10.f_04_Y;
			lolo.local_26->f_08 += (float)lolo.local_10.f_08_Z;
		}
		C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_10);
		C_00750134(&lolo.local_10, &lolo.local_12, 0, 0);
		if(C_0075045C()) {//else 00758F9E
			lolo.local_28.f_00_X = 0;
			lolo.local_28.f_02_Y = 0;
			lolo.local_28.f_04_Z = 0x28;
			lolo.local_28.f_06 = 0;
			C_00753D00(&lolo.local_28, C_00753DA9(lolo.local_1->f_00 - lolo.local_12.f_00_X, lolo.local_1->f_02 - lolo.local_12.f_04_Z));
			D_00E2A13C = lolo.local_28.f_00_X;
			D_00E2A140 = lolo.local_28.f_04_Z;
			//goto 00759136
		} else {
			lolo.local_6 = (lolo.local_1->f_06 * /*lolo.local_31*/max(0, 0xdac - inline_abs(lolo.local_12.f_00_X - lolo.local_1->f_00) - inline_abs(lolo.local_12.f_04_Z - lolo.local_1->f_02))) >> 0xc;
			lolo.local_4.f_00_X = 0;
			lolo.local_4.f_02_Y = lolo.local_1->f_04;
			lolo.local_4.f_04_Z = (lolo.local_6 * psx_rcos(lolo.local_5)) >> 0x10;
			psx_RotMatrixXYZ(&lolo.local_4, &lolo.local_21);
			psx_SetRotMatrix(&lolo.local_21);
			lolo.local_12.f_00_X = 0;
			lolo.local_12.f_02_Y = lolo.local_10.f_04_Y - 0x4e20;
			lolo.local_12.f_04_Z = 0;
			psx_RotTrans(&lolo.local_12, &lolo.local_25, &lolo.local_2);
			D_00E2A13C = lolo.local_25.f_00_X >> 4;
			D_00E2A140 = lolo.local_25.f_08_Z >> 4;
		}
	} else {
		D_00E2A13C =
		D_00E2A140 = 0;
...
void C_007591F3() {
	...
	if(C_00762136_PLAYER_GROUND_TYPE() == 0xe && (C_007186B9() & 0xf000)) {//menu_input:get "current mask"
		C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_5);
