...
void C_0075AD28(struct t_local_unknown_c0_WMOBJ *bp08, int bp0c) {
	struct {//x68
	...
	D_00E2D1F0.f_00_X = D_00E2D1F0.f_02_Y = D_00E2D1F0.f_04_Z = 0;
	D_00E2D1F8.f_00_X = D_00E2D1F8.f_02_Y = D_00E2D1F8.f_04_Z = 0;

	if(bp08->f_50_model == 3) {//else 0075B13E
		if(
			bp0c &&
			C_00768C59() &&
			C_0074D504() >= 0 &&
			/*lolo.local_23*/inline_abs(bp08->f_0c_POSITION.f_00_X - bp08->f_1c.f_00_X) + /*lolo.local_24*/inline_abs(bp08->f_0c_POSITION.f_08_Z - bp08->f_1c.f_08_Z) > 0x64
		) {//else 0075AFEE
			lolo.local_6 = D_00E35610 % 3;
			lolo.local_7 = D_00E35610 % 6;
			lolo.local_4 = C_0074D319();
			lolo.local_5 = lolo.local_4 * 4 + lolo.local_3;
			D_00E2D1E0 = bp08->f_0c_POSITION;
			D_00E2D1F8.f_00_X = 0x12c;
			D_00E2D1F8.f_02_Y = 0x190 - max(0, lolo.local_4);
			D_00E2D1F8.f_04_Z = -0x5a;
			C_0075B8F3(lolo.local_5, 0, ((lolo.local_4 * 4 < 0xc8)?0x24:0x27) + lolo.local_6, 0);
			C_0075B8F3(lolo.local_5, 0, lolo.local_7 + 0x32, 0);
			D_00E2D1F8.f_00_X = -0x12c;
			D_00E2D1F8.f_02_Y = 0x190 + min(0, lolo.local_4);
			C_0075B8F3(lolo.local_5, 0, ((lolo.local_4 * 4 > -0xc8)?0x27:0x24) + lolo.local_6, 0);
			C_0075B8F3(lolo.local_5, 0, lolo.local_7 + 0x32, 0);
			D_00E2D1F8.f_00_X = 0;
			D_00E2D1F8.f_02_Y = 0x12c;
			D_00E2D1F8.f_04_Z = -0x12c;
			C_0075B8F3(lolo.local_5, 0, lolo.local_6 + 0x2a, 0);
			C_0075B8F3(lolo.local_5, 0, lolo.local_7 + 0x32, 0);
		}
		if(lolo.local_2 >= 3 && lolo.local_2 <= 7 && bp08->f_0c_POSITION.f_04_Y < bp08->f_42 + 0x3e8 && (bp08->f_53 % 3) == 0) {//else 0075B139
			D_00E2D1F8.f_00_X = D_00E2D1F8.f_02_Y = D_00E2D1F8.f_04_Z = 0;
			D_00E2D1F0.f_00_X = (bp08->f_0c_POSITION.f_00_X - bp08->f_1c.f_00_X) >> 1;
			D_00E2D1F0.f_02_Y = 0x32;
			D_00E2D1F0.f_04_Z = (bp08->f_0c_POSITION.f_08_Z - bp08->f_1c.f_08_Z) >> 1;
			if(/*lolo.local_25*/inline_abs(D_00E2D1F0.f_00_X) + /*lolo.local_26*/inline_abs(D_00E2D1F0.f_04_Z) > 0x19) {//else 0075B139
				D_00E2D1E0.f_00_X -= D_00E2D1F0.f_00_X * 4;
				D_00E2D1E0.f_04_Y = bp08->f_42;
				D_00E2D1E0.f_08_Z -= D_00E2D1F0.f_04_Z * 4;
				C_0075B8F3(0, 0x700, 0, 0);
				C_0075B8F3(0, 0x900, 1, 0);
			}
		}
		// goto 0075B8EF
	} else if(bp0c && C_0076192A(bp08->f_50_model) && (bp08->f_53 == 2 || bp08->f_53 == 0xe) && ((0x1110701 >> lolo.local_2) & 1)) {//else 0075B21D
		D_00E2D1F0.f_00_X = bp08->f_0c_POSITION.f_00_X - bp08->f_1c.f_00_X;
		D_00E2D1F0.f_02_Y = 0x64;
		D_00E2D1F0.f_04_Z = bp08->f_0c_POSITION.f_08_Z - bp08->f_1c.f_08_Z;
		D_00E2D1E0.f_00_X -= D_00E2D1F0.f_00_X;
		D_00E2D1E0.f_04_Y += 0x64;
		D_00E2D1E0.f_08_Z -= D_00E2D1F0.f_04_Z;
		C_0075B8F3(0, 0x800, (lolo.local_2 != 0xa) + 5, 0x32);
		//goto 0075B8EF
	} else if(lolo.local_2 == 0xa && C_0074D330() != 3 && bp0c) {//else 0075B31D
		if(C_00761805(7, bp08->f_50_model) && (bp08->f_53 == 1 || bp08->f_53 == 8)) {//else 0075B2B5
			D_00E2D1F8.f_04_Z = 0x28;
			C_0075B8F3(((bp08->f_53 >> 3)?0x400:0xc00) + lolo.local_3, 0, (bp08->f_53 >> 3)?2:3, 0);
		} else if(C_0076192A(bp08->f_50_model) && (bp08->f_53 == 1 || bp08->f_53 == 0xd)) {//else 0075B318
			D_00E2D1F8.f_04_Z = 0x78;
			C_0075B8F3(((bp08->f_53 >> 3)?0xc00:0x400) + lolo.local_3, 0, 4, 0);
		}
		//goto 0075B8EF
	} else if(C_00761805(7, bp08->f_50_model) && ((lolo.local_2 & 0xf) == 8 || lolo.local_2 == 0x1c) && (bp08->f_53 == 1 || bp08->f_53 == 8)) {//else 0075B38D
		D_00E2D1F0.f_00_X = 0;
		D_00E2D1F0.f_02_Y = 0x14;
		D_00E2D1F0.f_04_Z = 0;
		C_0075B8F3(0, 0, 8, 0);
		//goto 0075B8EF
	} else if(C_00761805(0x20, bp08->f_50_model) && C_00761FE8() == 0) {//else 0075B404
		if(bp0c && (bp08->f_53 % 3) == 0) {//else 0075B3FF
			D_00E2D1F8.f_00_X = 0x190;
			C_0075B8F3(lolo.local_3, 0, 9, 0);
			D_00E2D1F8.f_00_X = -0x1f4;
			C_0075B8F3(lolo.local_3, 0, 9, 0);
		}
		//goto 0075B8EF
	} else if(bp0c && (C_00761805(7, bp08->f_50_model) || C_0076192A(bp08->f_50_model)) && (lolo.local_2 == 1 || lolo.local_2 == 0x19) && (bp08->f_53 % 3) == 0) {//else 0075B47C
		D_00E2D1E0.f_04_Y += 0x12c;
		C_0075B8F3(lolo.local_3, 0, 0xa, 0);
		//goto 0075B8EF
	} else if(C_00761805(7, bp08->f_50_model) && lolo.local_2 == 7) {//else 0075B4F3
		...
		//goto 0075B8EF
	} else if(bp0c && C_0076192A(bp08->f_50_model) && lolo.local_2 >= 3 && lolo.local_2 <= 7 && (bp08->f_53 == 1 || bp08->f_53 == 0xd)) {//else 0075B553
		D_00E2D1F8.f_04_Z = -0x64;
		C_0075B8F3(lolo.local_3, 0, 0xd, 0);
		//goto 0075B8EF
	} else if(bp0c && bp08->f_50_model == 6) {//else 0075B76C
		if((lolo.local_2 == 1 || lolo.local_2 == 0x19) && (bp08->f_53 % 3) == 0) {//else 0075B5B5
			...
			D_00E2D1F0.f_02_Y = 0x14;
			D_00E2D1F8.f_02_Y = 0x64;
			D_00E2D1F8.f_04_Z = -0x12c;
			D_00E2D1F8.f_00_X = 0x96;
			...
			psx_RotMatrixX(lolo.local_9.f_00_X, &lolo.local_22);
			psx_RotMatrixZ(lolo.local_9.f_04_Z, &lolo.local_22);
			psx_SetRotMatrix(&lolo.local_22);
			psx_RotTrans(&D_00E2D1F8, &lolo.local_14, &lolo.local_1);

			D_00E2D1F8.f_00_X = lolo.local_14.f_00_X;
			D_00E2D1F8.f_02_Y = lolo.local_14.f_04_Y;
			D_00E2D1F8.f_04_Z = lolo.local_14.f_08_Z;
		...
		//goto 0075B8EF
	} else if(bp0c && bp08->f_50_model == 0xd) {//else 0075B811
		if(C_0074D330() == 2 && (bp08->f_53 & 7) == 0) {//else 0075B7D3
			D_00E2D1F8.f_02_Y = 0xc8;
			D_00E2D1F8.f_04_Z = -0x190;
			D_00E2D1F0.f_02_Y = 0x32;
			C_0075B8F3(lolo.local_3, lolo.local_3, 0x11, 0);
		} else if(C_0074D330() == 0) {
			D_00E2D1F8.f_02_Y = 0xF0;
			D_00E2D1F8.f_04_Z = -0x1f4;
			C_0075B8F3(lolo.local_3, 0, (D_00E35610 & 3) + 0x2d, 0);
		}
		//goto 0075B8EF
	} else if(bp0c && bp08->f_50_model == 0x1e && (bp08->f_53 & 0xf) == 0) {//else 0075B8B1
		D_00E2D1F8.f_00_X = 0x258;
		D_00E2D1F8.f_02_Y = 0x3E8;
		D_00E2D1F8.f_04_Z = -0x190;
		D_00E2D1F0.f_02_Y = 0x32;
		C_0075B8F3(lolo.local_3, lolo.local_3, 0x11, 0);
		D_00E2D1F8.f_00_X = -0x258;
		...
		C_0075B8F3(lolo.local_3, lolo.local_3, 0x11, 0);
		//goto 0075B8EF
	} else if(bp0c && bp08->f_50_model == 8 && (bp08->f_53 & 3) == 0) {//else 0075B8EF
		D_00E2D1F8.f_04_Z = -0x2bc;
...
void C_0075B8F3(short bp08, short bp0c, short bp10, int bp14) {
	...
	if(lolo.local_1) {
		...
		lolo.local_4.f_00_X =
		lolo.local_4.f_04_Z = 0;
		lolo.local_4.f_02_Y = bp0c;
		...
		lolo.local_1->f_14 = lolo.local_17.f_00_X;
		lolo.local_1->f_16 = lolo.local_17.f_04_Y;
		lolo.local_1->f_18 = lolo.local_17.f_08_Z;
		lolo.local_1->f_04 = D_00E2D1E0;
		lolo.local_4.f_02_Y = bp08;
		psx_RotMatrixXYZ(&lolo.local_4, &lolo.local_13);
		psx_SetRotMatrix(&lolo.local_13);
		psx_RotTrans(&D_00E2D1F8, &lolo.local_17, &lolo.local_5);
		lolo.local_1->f_04.f_00_X = D_00E2D1E0.f_00_X + lolo.local_17.f_00_X;
		lolo.local_1->f_04.f_04_Y = D_00E2D1E0.f_04_Y + lolo.local_17.f_04_Y;
		lolo.local_1->f_04.f_08_Z = D_00E2D1E0.f_08_Z + lolo.local_17.f_08_Z;
...
void C_0075BB25() {
	...
	D_00E2D1F0.f_04_Z = 0;
	D_00E2D200 = 0;
	C_00762798_SET_VECTOR_TO_PLAYER_POS(&D_00E2D1E0);
	D_00E2D1F8.f_00_X = D_00E2D1F8.f_02_Y =  D_00E2D1F8.f_04_Z = 0;
	C_0075B8F3(0, 0, 7, 0);
...
void C_0075BBB3(struct t_local_unknown_c0_WMOBJ *bp08, int bp0c) {
	struct {
		int bp_0c;
		int bp_08;
	...
	switch(bp0c) {
		case 0x14: case 0x15: case 0x16:
			D_00E2D1F8.f_02_Y = C_0074D28E()?0x12c:0x258;
			D_00E2D1F8.f_04_Z = -0xc8;
		...
		case 0x01:
			D_00E2D200 = 0;
			D_00E2D1F8.f_04_Z = 0x1F4;
			D_00E2D1F0.f_04_Z = 0x1E;
			C_0075B8F3(0, 0, 0x1c, 0);
			D_00E2D1F8.f_04_Z = -0x1f4;
			D_00E2D1F0.f_04_Z = -0x1e;
			C_0075B8F3(0, 0, 0x20, 0);
			D_00E2D1F8.f_04_Z = 0x161;
			D_00E2D1F0.f_04_Z = 0x15;
			D_00E2D1F8.f_00_X = 0x161;
			D_00E2D1F0.f_00_X = 0x15;
		...
		break;
		case 0x02:
			lolo.bp_0c = C_00753BE8_RAND() << 4;
			D_00E2D1F0.f_00_X = psx_rcos(lolo.bp_0c) >> 6;
			D_00E2D1F0.f_02_Y = 0x78;
			D_00E2D1F8.f_04_Z = 0x1F4;
			C_0075B8F3(lolo.bp_0c, 0, 0x31, 0x14);
		break;
		case 0x03:
			D_00E2D1F8.f_02_Y = 0x12C;
			D_00E2D1F8.f_04_Z = -0x3e8;
			D_00E2D1F0.f_02_Y = 0x14;
			D_00E2D1F0.f_04_Z = -0xa;
			C_0075B8F3(bp08->f_3c, bp08->f_3c + C_00753BE8_RAND() * 8 - 0x400, 0x38, 1);
		break;
		case 0x04:
			D_00E2D1F8.f_00_X = 0x1E;
			D_00E2D1F8.f_02_Y = 0x190;
			D_00E2D1F8.f_04_Z = 0x1F4;
...
void C_0075C0FD() {
	...
	lolo.local_7.f_00_X = 0;
	lolo.local_7.f_02_Y = -C_0074D298();
	lolo.local_7.f_04_Z = 0;
	psx_RotMatrixYXZ(&lolo.local_7, &lolo.local_28);
	lolo.local_7.f_00_X = -C_0074D3C6();
	...
	for(lolo.local_1 = D_00E35648; lolo.local_1; lolo.local_1 = lolo.local_1->f_00) {
		lolo.local_10 = lolo.local_1->f_04.f_00_X - lolo.local_5.f_00_X;
		lolo.local_11 = lolo.local_1->f_04.f_04_Y - D_00DE6A04;
		lolo.local_20 = lolo.local_1->f_04.f_08_Z - lolo.local_5.f_08_Z;
		if(lolo.local_10 > -0x7530 && lolo.local_10 < 0x7530 && lolo.local_20 > -0x7530 && lolo.local_20 < 0x7530) {
			lolo.local_9.f_00_X = lolo.local_10;
			lolo.local_9.f_02_Y = lolo.local_11 - C_00762F9A(lolo.local_10, lolo.local_20);
			lolo.local_9.f_04_Z = lolo.local_20;
			if(lolo.local_1->f_1e) {
				lolo.local_7.f_00_X =
				lolo.local_7.f_04_Z = 0;
				lolo.local_7.f_02_Y = lolo.local_1->f_1a;
...
void C_0075C283(struct t_wm_local_30 *bp08, struct t_wm_local_spr_0c *bp0c, struct SVECTOR *bp10, short bp14) {
	...
	lolo.bp_128.f_00_X =
	lolo.bp_128.f_04_Y =
	lolo.bp_128.f_08_Z = 0;
	psx_TransMatrix(&lolo.bp_190, &lolo.bp_128);
	psx_SetTransMatrix(&lolo.bp_190);
	lolo.bp_1a4.f_00_X = (-bp0c->f_02) * 8;
	if(bp14) {
		lolo.bp_1a4.f_02_Y = 0;
		lolo.bp_1a4.f_04_Z = (-bp0c->f_03) * 8;
	} else {
		lolo.bp_1a4.f_02_Y = (-bp0c->f_03) * 8;
		lolo.bp_1a4.f_04_Z = 0;
	}
	psx_RotTrans(&lolo.bp_1a4, &lolo.bp_10, &lolo.bp_108);
	lolo.bp_110.f_00_X = lolo.bp_10.f_00_X;
	lolo.bp_110.f_02_Y = lolo.bp_10.f_04_Y;
	lolo.bp_110.f_04_Z = lolo.bp_10.f_08_Z;
	lolo.bp_1a4.f_00_X += bp0c->f_02 * 16;
	psx_RotTrans(&lolo.bp_1a4, &lolo.bp_10, &lolo.bp_108);
	lolo.bp_118.f_00_X = lolo.bp_10.f_00_X;
	lolo.bp_118.f_02_Y = lolo.bp_10.f_04_Y;
	lolo.bp_118.f_04_Z = lolo.bp_10.f_08_Z;
	if(bp14)
		lolo.bp_1a4.f_04_Z += bp0c->f_03 * 16;
	else
		lolo.bp_1a4.f_02_Y += bp0c->f_03 * 16;
	psx_RotTrans(&lolo.bp_1a4, &lolo.bp_10, &lolo.bp_108);
	lolo.bp_144.f_00_X = lolo.bp_10.f_00_X;
	lolo.bp_144.f_02_Y = lolo.bp_10.f_04_Y;
	lolo.bp_144.f_04_Z = lolo.bp_10.f_08_Z;
	lolo.bp_1a4.f_00_X -= bp0c->f_02 * 16;
	psx_RotTrans(&lolo.bp_1a4, &lolo.bp_10, &lolo.bp_108);
	lolo.bp_130.f_00_X = lolo.bp_10.f_00_X;
	lolo.bp_130.f_02_Y = lolo.bp_10.f_04_Y;
	lolo.bp_130.f_04_Z = lolo.bp_10.f_08_Z;
	...
	lolo.bp_2c.f_00 = /*lolo.bp_1e0*/(float)lolo.bp_110.f_00_X;
	lolo.bp_2c.f_04 = /*lolo.bp_1e4*/(float)lolo.bp_110.f_02_Y;
	lolo.bp_2c.f_08 = /*lolo.bp_1e8*/(float)lolo.bp_110.f_04_Z;
	lolo.bp_48.f_00 = /*lolo.bp_1ec*/(float)lolo.bp_118.f_00_X;
	lolo.bp_48.f_04 = /*lolo.bp_1f0*/(float)lolo.bp_118.f_02_Y;
	lolo.bp_48.f_08 = /*lolo.bp_1f4*/(float)lolo.bp_118.f_04_Z;
	lolo.bp_a4.f_00 = /*lolo.bp_1f8*/(float)lolo.bp_130.f_00_X;
	lolo.bp_a4.f_04 = /*lolo.bp_1fc*/(float)lolo.bp_130.f_02_Y;
	lolo.bp_a4.f_08 = /*lolo.bp_200*/(float)lolo.bp_130.f_04_Z;
	lolo.bp_c4.f_00 = /*lolo.bp_204*/(float)lolo.bp_144.f_00_X;
	lolo.bp_c4.f_04 = /*lolo.bp_208*/(float)lolo.bp_144.f_02_Y;
	lolo.bp_c4.f_08 = /*lolo.bp_20c*/(float)lolo.bp_144.f_04_Z;
...
//0075CF02
	while(lolo.bp_04) {//else 0075D43E
		...
		lolo.bp_04->f_04.f_00_X += lolo.bp_04->f_14;
		lolo.bp_04->f_04.f_04_Y += lolo.bp_04->f_16;
		lolo.bp_04->f_04.f_08_Z += lolo.bp_04->f_18;
...
int _ocal_3[3];
	...
	lolo.local_73.f_00_X = bp18->f_00.pad1;
	lolo.local_73.f_02_Y = -D_00DE6A04;
	lolo.local_73.f_04_Z = bp18->f_00.pad2;
	...
	lolo.local_22.f_00_X = lolo.local_22.f_04_Z = 0;
	lolo.local_22.f_02_Y = bp14;
...
//shadow related?
void C_0075DEAA(struct t_local_unknown_c0_WMOBJ *bp08) {
	struct {
	...
	lolo.bp_04 = 0x20 - ((bp08->f_0c_POSITION.f_04_Y - bp08->f_48) >> 8);
	if(lolo.bp_04 < 0)
		lolo.bp_04 = 0;
	...
	lolo.bp_04 = 0x64 - ((bp08->f_0c_POSITION.f_04_Y - bp08->f_48) >> 6);
	switch(bp08->f_50_model) {
...
void C_0075E0BA(struct t_wm_b8 *bp08, struct t_local_unknown_c0_WMOBJ *bp0c, short bp10, short bp14, struct SVECTOR *bp18) {
	struct {//x298
	...
	lolo.local_79 = bp0c?bp0c->f_50_model:-1;
	C_0074D50E(bp08, bp18, &lolo.local_46, lolo.local_79 == C_00761735_PLAYER_CURRENT_MODEL());
...
void C_0075E4D6(short bp08, short bp0c) {
	...
	if(lolo.local_3) {
		lolo.local_8.r = /*lolo.local_9*/(float)D_0096DD78[bp0c].f_00_X * 0.003921569f;
		lolo.local_8.g = /*lolo.local_10*/(float)D_0096DD78[bp0c].f_02_Y * 0.003921569f;
		lolo.local_8.b = /*lolo.local_11*/(float)D_0096DD78[bp0c].f_04_Z * 0.003921569f;
		lolo.local_8.a = 1.0f;
