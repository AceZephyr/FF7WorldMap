...
int C_0074CC07_updateObjMeshMaybe(struct t_wm_local_18 *bp08, struct SVECTOR *bp0c, struct t_wm_local_08_MESHHEADER *bp10, short *bp14, struct t_wm_local_0c_TRIANGLE **bp18, short *bp1c, unsigned char bp20) {
	struct {
		int local_12;
		int local_11;
		struct t_wm_local_0c_TRIANGLE *local_10;
		int local_9;
		struct t_wm_local_0c_TRIANGLE *local_8;
		int local_7;
		struct SVECTOR *local_6;//size 8
		struct t_wm_local_08_MESHHEADER *local_5;//size 8
		int local_4;
		int local_3;
		int local_2;
		int local_1;
	...
	*lolo.local_6 = *bp0c;
	...
	if(bp10) {
		for(lolo.local_5 = bp10; lolo.local_5 < &(bp10[6]) && lolo.local_3 <= 0; lolo.local_5 ++) {
			if(lolo.local_5->f_00_triPtr)
			if(lolo.local_5->f_04_numTriangles == bp08->f_10 && lolo.local_5->f_06_numVertices == bp08->f_12)
			if(C_0076085F(lolo.local_5->f_00_triPtr, lolo.local_6, &lolo.local_1)) {
				lolo.local_12 = lolo.local_5->f_00_triPtr->f_03_walkability | (lolo.local_5->f_00_triPtr->f_0b << 8);
				lolo.local_11 = lolo.local_1;
				lolo.local_3 = -1;
				if(C_0074CECA(lolo.local_12, bp20)) {
					lolo.local_10 = lolo.local_5->f_00_triPtr;
					lolo.local_3 = 1;
				}
			}
		}//end for
	...
	if(lolo.local_3 == 0) {//else 0074CE8F
		for(lolo.local_8 = bp08->f_04; lolo.local_8 < &(bp08->f_04[bp08->f_14]); lolo.local_8 ++) {
			if(C_0076085F(lolo.local_8, lolo.local_6, &lolo.local_1)) {
				lolo.local_7 = lolo.local_8->f_03_walkability | (lolo.local_8->f_0b << 8);
		...
		if(lolo.local_3) {//else 0074CE8F
			if(bp10 && lolo.local_10) {//else 0074CE6D
				...
				bp10->f_00_triPtr = lolo.local_10; // updates mesh here
				bp10->f_04_numTriangles = bp08->f_10;
				bp10->f_06_numVertices = bp08->f_12;
			}
...
int C_0074CECA(int bp08, unsigned char bp0c) {
	...
	lolo.bp_04 = /*bp_0c*/(C_00762136_PLAYER_GROUND_TYPE() == 0xd || C_00762136_PLAYER_GROUND_TYPE() == 0xe) && (C_00761735_PLAYER_CURRENT_MODEL() == bp0c);
	switch(bp0c) {
		case 0x00:
		case 0x01:
		case 0x02:
...
void C_0074D33A(struct SVECTOR *bp08) {
	...
	lolo.local_2 = *bp08;
	lolo.local_2.f_02_Y = -D_00DE6A04;
...
void C_0074D50E(struct t_wm_b8 *bp08, struct SVECTOR *pRot/*bp0c*/, struct MATRIX *bp10, int bp14) {
	...
	//-- --
	psx_RotMatrixX(pRot->f_00_X, &lolo.local_15);
	psx_RotMatrixZ(pRot->f_04_Z, &lolo.local_15);
	psx_RotMatrixY(pRot->f_02_Y, &lolo.local_15);
	psx_MulMatrix0(&D_00DFC448, &lolo.local_15, bp10);
	psx_SetRotMatrix(&D_00DFC448);
	if(D_00DFC46C > 0 && bp14) {
		lolo.local_6.f_00_X = D_00DE6A20.f_12[0] / 2;
		lolo.local_6.f_04_Y = D_00DE6A20.f_12[1] / 2;
		lolo.local_6.f_08_Z = D_00DE6A20.f_12[2] / 2;
		D_00DFC46C --;
		if(D_00DFC46C == 0)
			C_0075E5C0(D_00E3564C);
	} else {
		lolo.local_6.f_00_X = D_00DE6A20.f_12[0];
		lolo.local_6.f_04_Y = D_00DE6A20.f_12[1];
		lolo.local_6.f_08_Z = D_00DE6A20.f_12[2];
	}
	psx_TransMatrix(bp10, &lolo.local_6);
	psx_SetTransMatrix(bp10);
	lolo.local_2.f_00_X = /*ftol*/(short)bp08->f_44.sPos.f_00;
	lolo.local_2.f_02_Y = /*ftol*/(short)bp08->f_44.sPos.f_04;
	lolo.local_2.f_04_Z = /*ftol*/(short)bp08->f_44.sPos.f_08;
...
int C_0074DB8C(int *bp08, int *bp0c, int *bp10, int bp14) {
	...
	if(D_00E045E4 < 9) {//else 0074E1E0
		if(D_00DE69E0 == 0) {//else 0074DE7C
			...
			C_007640BC(0);
			C_007641A7_ScriptLoop();
			D_00DF5420 = (C_00761735_PLAYER_CURRENT_MODEL() != 3)?0x7d0:0xfa0;
		...
		if(D_00E045E4 < 6) {//else 0074E16B
			if(D_00E045EC == 0) {//else 0074DFBF
				...
				C_0076315C();
				//-- --
				C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_6);
				lolo.local_1 = inline_abs(lolo.local_6.f_04_Y - D_00DE6A04);
				if(D_00DFC48C != 2) {//else 0074DF6C
					D_00DE6A04 = /*lolo.local_16*/(C_00761F77() == 0 && lolo.local_1 <= 200)?
						/*lolo.local_15*/(lolo.local_1 > 0x32)?D_00DE6A04 + ((lolo.local_6.f_04_Y > D_00DE6A04)?0x32:-0x32):lolo.local_6.f_04_Y:
						((D_00DE6A04 * 7 + lolo.local_6.f_04_Y) >> 3)
					;
				}
				C_0074EA48();
				C_0074DA4D();
			...
			if(D_00E045EC == 0) {//else 0074E16B
				...
				C_007689F7();
				if(D_00E045E4 == 1)
					C_00767540_WALKFRAME_DOSTEPFRAC();
...
void C_0074E505() {
	...
	if(D_00DFC4A0) {//else 0074E58D
		//-- earthquake effect
		if(D_00DE69D8 == 1) {
			local_1 = (C_00753BE8_RAND() >> 6) - 2;
			local_2 = D_00DE6B4C - 0x7a + (C_00753BE8_RAND() >> 6);
		} else {
			local_1 = ((C_00753BE8_RAND() >> 6) - 2) * 2;
			local_2 = (D_00DE6B4C - 0x7a + (C_00753BE8_RAND() >> 6)) * 2;
		}
...
void C_0074E8CE(short bp08) {
	...
	lolo.local_3.f_00_X = C_0074F916();
	lolo.local_3.f_02_Y =
	lolo.local_3.f_04_Z = 0;
	psx_RotMatrixXYZ(&lolo.local_3, &lolo.local_27);
	lolo.local_11.f_00_X =
	lolo.local_11.f_04_Y =
	lolo.local_11.f_08_Z = 0;
	...
	lolo.local_3.f_04_Z = D_00DFC478;
	psx_RotTrans(&lolo.local_3, &lolo.local_7, &lolo.local_1);
	lolo.local_11.f_00_X = 0;
	lolo.local_11.f_04_Y = 0;
	lolo.local_1 = (lolo.local_7.f_04_Y << 4) - D_00DE6A04;
	lolo.local_11.f_08_Z = D_00DFC478;
	psx_TransMatrix(&D_00DE6A20, &lolo.local_11);
	lolo.local_1 = (lolo.local_1 << 8) / (lolo.local_7.f_08_Z << 4);
	if(lolo.local_1 < 0)
		lolo.local_1 = 0;
	else if(lolo.local_1 >= 0x200)
		lolo.local_1 = 0x1ff;
	D_00DE7418 =
	lolo.local_3.f_00_X = D_00E37120[lolo.local_1] + 0x800;
	lolo.local_3.f_02_Y = bp08;
	lolo.local_3.f_04_Z = 0;
	psx_RotMatrixXYZ(&lolo.local_3, &lolo.local_27);
	lolo.local_3.f_00_X =
	lolo.local_3.f_02_Y = 0;
	lolo.local_3.f_04_Z = D_00DE6B70;
...
void C_0074EA48() {
	...
	lolo.local_1 = 0;
	C_007616B3();
	lolo.local_10 = C_00761735_PLAYER_CURRENT_MODEL();//current transportation mode?
	if(D_00DE6B5C && D_00DFC4B8 <= 0 && C_0075335C()) {//else 0074F734
		...
		if(C_00761769_PLAYERMODEL_MASK(0x2000) && D_00DFC4B4 == 2 && D_00E045E8 != 2 && (lolo.local_14 & 0x20))
		...
		if(D_00DFC4B4 == 2 || D_00DFC4B4 == 3 || D_00E045E8 == 3) {//else 0074F4FE
			...
			lolo.local_13.f_00_X = lolo.local_26;
			lolo.local_13.f_02_Y = 0;
			lolo.local_13.f_04_Z = lolo.local_1;
			lolo.local_5.f_00_X =
			lolo.local_5.f_04_Z = 0;
			lolo.local_5.f_02_Y = -D_00DFC484;
			psx_RotMatrixXYZ(&lolo.local_5, &lolo.local_23);
			lolo.local_9.f_00_X =
			lolo.local_9.f_04_Y =
			lolo.local_9.f_08_Z = 0;
			...
			lolo.local_26 = lolo.local_30.f_00_X;
			lolo.local_1 = lolo.local_30.f_08_Z;
			lolo.local_24 = 0;
			if(D_00DFC4B4 == 3 && lolo.local_15 == 0) {//else 0074F291
				C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_9);
				if(((lolo.local_14 & 0x1000) && lolo.local_9.f_04_Y > 0x1f4 && D_00DE6A14 && C_00762136_PLAYER_GROUND_TYPE() != 0x1b) || lolo.local_9.f_04_Y > D_00DF5420) {
					C_00761F22(D_00DFC480 * -0x32);
					lolo.local_24 = 0xa;
				} else if((lolo.local_14 & 0x4000) && lolo.local_9.f_04_Y < D_00DF5420 - D_00DFC480 * 0x32) {
					C_00761F22(D_00DFC480 * 0x32);
					lolo.local_24 = -0xa;
				}
			}
			if(D_00E045E8 == 2) {//else 0074F30B
				C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_9);
				if((lolo.local_14 & 0x1000) && lolo.local_9.f_04_Y > -5000 && D_00DE6A14) {
					C_00761F22(D_00DFC480 * -30);
					lolo.local_24 = 10;
				}
				if((lolo.local_14 & 0x4000) && lolo.local_9.f_04_Y < -3000) {
					C_00761F22(D_00DFC480 * 30);
					lolo.local_24 = -10;
				}
			}
		...
		if(C_00761769_PLAYERMODEL_MASK(0x2000) && (lolo.local_14 & 0x40) && (D_00DFC470 & 0x40) == 0) {
			if(D_00E045E8 == 2 && C_00762136_PLAYER_GROUND_TYPE() == 3)
				C_0074D6BB();
			else if(C_00762136_PLAYER_GROUND_TYPE() == 3)
				C_0074D6F6();
		}
		if(
		...
		if((lolo.local_14 & 0x10) && (D_00DFC470 & 0x10) == 0 && D_00E045E4 == 1) {//else 0074F6C6
			if(lolo.local_10 == 3) {
				C_007640BC(6);
			} else if(C_00761769_PLAYERMODEL_MASK(0x47) && C_00762136_PLAYER_GROUND_TYPE() != 0xe) {
				C_00755B97(0x10, 1);
				C_0074D438(0, 1);
				D_00E045E4 = 2;
				C_0074C980(0);//set "allowsFrameSkip"?
		...
		if(lolo.local_14 & 0xa00c) // L, R, L1, R1 RNG call
			C_00753BE8_RAND();
		D_00DFC470 = lolo.local_14;
		if(C_00762136_PLAYER_GROUND_TYPE() == 0xe)
	...
	if(D_00DE6B5C == 0 && C_00762136_PLAYER_GROUND_TYPE() == 0xe) {
		C_007591C2(&lolo.local_26, &lolo.local_1);
		C_00762E87(lolo.local_26, lolo.local_1);
		C_0076296E();
	}
...
int C_0074F916() {
	...
	if(D_00DE6A08) {//else 0074FAAE
		...
		if(D_00DFC49C) {//else 0074FA80
			...
			C_0076271B(lolo.local_6 + ((((/*lolo.local_12*/(D_00DE6A08 > 0)?D_00DF5420:lolo.local_10.f_04_Y) - lolo.local_6) * D_00DE6A40) >> 8));
...
void C_0074FBEC() {
	...
	switch(D_00E045E4) {
		...
		break;
		case 4: case 5:
			C_00762798_SET_VECTOR_TO_PLAYER_POS(&bp_10);
			C_00762702(bp_10.f_04_Y + D_00DFC490);
