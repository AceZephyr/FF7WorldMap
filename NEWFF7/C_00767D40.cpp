...
void C_00767D68(short bp08) {
	...
	if(D_00E3A898 < 2) {//else 0076831B
		...
		lolo.local_7 = C_00761735_PLAYER_CURRENT_MODEL();//current transportation mode?
		//-- positions on map --
		for(lolo.i = 0; lolo.i < 6; lolo.i ++) {
			if(/*lolo.local_36*/lolo.i?
				...
				lolo.local_10[0] = lolo.local_15 + ((D_00E3A89C * lolo.local_14.f_00_X) >> 0xf) - D_00DE69D8 * 4 + D_00E2C424;
				lolo.local_10[1] = lolo.local_17 + ((D_00E3A89C * lolo.local_14.f_08_Z) >> 0xf) - D_00DE69D8 * 4 + D_00E2C428;
		...
		if(C_0074D28E() == 2 || C_0074D28E() == 3) {//else 00768232
			C_00762798_SET_VECTOR_TO_PLAYER_POS(&lolo.local_14);
			lolo.local_30[0] = lolo.local_15 + ((D_00E3A89C * lolo.local_14.f_00_X) >> 0xf) + D_00E2C424;
			lolo.local_30[1] = lolo.local_17 + ((D_00E3A89C * lolo.local_14.f_08_Z) >> 0xf) + D_00E2C428;
			lolo.local_2.f_00_X =
			lolo.local_2.f_02_Y = 0;
			lolo.local_2.f_04_Z = bp08;
			psx_RotMatrixXYZ(&lolo.local_2, &lolo.local_26);
			lolo.local_6.f_00_X = 
			lolo.local_6.f_04_Y =
			lolo.local_6.f_08_Z = 0;
			...
			lolo.local_2.f_00_X = lolo.i >> 1;
			lolo.local_2.f_02_Y = lolo.i;
			psx_RotTrans(&lolo.local_2, &lolo.local_6, &lolo.local_8);
			lolo.local_29[0] = lolo.local_30[0] + lolo.local_6.f_00_X;
			lolo.local_29[1] = lolo.local_30[1] + lolo.local_6.f_04_Y;
			lolo.local_2.f_00_X = -lolo.local_2.f_00_X;
			psx_RotTrans(&lolo.local_2, &lolo.local_6, &lolo.local_8);
			lolo.local_28[0] = lolo.local_30[0] + lolo.local_6.f_00_X;
			lolo.local_28[1] = lolo.local_30[1] + lolo.local_6.f_04_Y;
...
void C_0076831F(short bp08) {
	D_00E3A898 = bp08;
	if(C_00761735_PLAYER_CURRENT_MODEL() != 3)
